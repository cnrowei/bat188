var ReactScrollBar = {
    ...
    getDefaultProps: function() {
        var n = navigator.platform == "MacIntel", t = /Firefox/.test(navigator.userAgent);
        return {
...
Homepage.mainFeatureEvent.header = React.createClass({
    ...
    render: function() {
        ...
        s = React.createElement("div", {
            className: "div-lineHeight-lv1" + (r == null ? "" : " mg-t-4")
        }, w, b)),
        k = nt ? tt + " - " + it : "v",
...
Homepage.secondaryFeatureEvent.eventForm = React.createClass({
    ...
    render: function() {
        ...
        return i ? (s.showScore = w,
        s.period = n.i[31],
        s.time = HP_Store.initTimerString(n.i[5])) : s.edt = n.edt,
...
AllMarketPage.ScoreBoardInplay = React.createClass({
    ...
    render: function() {
        ...
        }, this._getIPTime(s, t.elapsed)) : null , !isNaN(parseInt(h)) && t.marketsCount > 0 ? React.createElement("span", {
...
AllMarketPage.FilterButtons = React.createClass({
    ...
    render: function() {
        if (this.props.inPlay || this.props.sportID != 1 || typeof this.props.filters == "undefined")
            return null ;
...
AllMarketPage.Market.HeadLine = React.createClass({
    ...
    render: function() {
        var n = this.props.data, r = "", t, e, u, f, i;
        ...
        i = n.market.n,
        n.period != "" && (n.market.n.lastIndexOf("- ") > -1 && (i = n.market.n.replace(n.market.n.slice(n.market.n.lastIndexOf("- ") + 1), "")),
        f = React.createElement("span", {
            key: "1",
            className: "ft-c-3 fts-15"
        }, n.market.n.replace(i, ""))),
        u = [i, r, f]),
        React.createElement("div", {
            ...
            className: "myFavorite" + (n.isMyMk ? " actived" : ""),
...
AllMarketPage.Market.MarketType = React.createClass({
    ...
    render: function() {
        ...
        case "ah":
        case "ou":
            i = (t.childEventTypeId == null || t.childEventTypeId == 0) && (t.sID == 1 || t.sID == 2) ? React.createElement(AllMarketPage.Market.MarketType.AHOU_FbBb, {
                data: t
        ...
        return React.createElement("table", {
            ...
            return React.createElement("tr", {
                ...
                return React.createElement("td", {
                    ...
                    className: t.length == 5 ? "col-fixed95" : "col-fixed45"
                })), React.createElement("tbody", null , React.createElement("tr", null , React.createElement("td", {
                    className: "t-a-l ft-c-25 lht-14 pd-r-10" + (this.isOddsUnaval(u.value) ? " nopointer nohighlight" : "")
                }, u.name), React.createElement("td", {
...
RightPanel.Utility = {
    ...
    link: {
        _getMorebetLink: function(n, t, i) {
            viewType = t == 2 ? VIEW.INPLAY : t == 0 ? VIEW.PRESTART : VIEW.STARTINGSOON;
...
RightPanel.betSlips.betEntry = React.createClass({
    ...
    render: function() {
        ...
        n.serr != null && (d = React.createElement(RightPanel.betSlips.errorMsg, {
...
RightPanel.myBet.unsettleBet = React.createClass({
    ...
    render: function() {
        ...
        React.createElement("div", {
            ...
            className: e ? "active" : ""
        }, l.MyBet_All), React.createElement("li", {
            onClick: this._switchTab.bind(this, !1),
            className: e ? "" : "active"
        }, l.MyBet_Inplay_Now)), React.createElement("div", {
...
RightPanel.myBet.betItem = React.createClass({
    ...
    render: function() {
        ...
        (t || n.wr != null ) && (f = React.createElement(RightPanel.myBet.betItem.status, {
            data: e
        })),
...
RightPanel.myBet.betItem.status = React.createClass({
    ...
    render: function() {
        ...
        t = [],
        i != null && (t.push(React.createElement("span", {
            key: "mb_st_i",
