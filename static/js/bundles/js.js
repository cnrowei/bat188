var TrimPath, Timer, opSetting, HP_Store, LPM, myEvents, OddsHeader, AMStore, BS_Store, MB;

(function(n, t) {
    function i(t, i) {
        var u, f, e, o = t.nodeName.toLowerCase();
        return "area" === o ? (u = t.parentNode, f = u.name, !t.href || !f || u.nodeName.toLowerCase() !== "map") ? !1 :(e = n("img[usemap=#" + f + "]")[0], 
    ...
    (n.ui = n.ui || {}, n.ui.version) || (n.extend(n.ui, {
        ...
        zIndex:function(i) {
            ...
            if (this.length) for (var r = n(this[0]), u, f; r.length && r[0] !== document; ) {
                if (u = r.css("position"), (u === "absolute" || u === "relative" || u === "fixed") && (f = parseInt(r.css("zIndex"), 10), 
                !isNaN(f) && f !== 0)) return f;
                r = r.parent();
            }
            return 0;
        },
        ...
        n.each(r, function(t, u) {
            n.isFunction(u) && (r[t] = function() {
                ...
                return function() {
                    ...
                    return this._super = n, this._superApply = r, t = u.apply(this, arguments), this._super = i, 
                    this._superApply = f, t;
                };
            }());
        });
    ...
    n.widget.extend = function(r) {
        for (var o = i.call(arguments, 1), e = 0, s = o.length, u, f; e < s; e++) for (u in o[e]) f = o[e][u], 
    ...
    n.widget.bridge = function(r, u) {
        ...
        n.fn[r] = function(e) {
            ...
            return e = !h && o.length ? n.widget.extend.apply(null, [ e ].concat(o)) :e, h ? this.each(function() {
                ...
                i !== u && i !== t ? (s = i && i.jquery ? s.pushStack(i.get()) :i, !1) :void 0) :n.error("cannot call methods on " + r + " prior to initialization; attempted to call method '" + e + "'");
            }) :this.each(function() {
                var t = n.data(this, f);
    ...
    n.Widget.prototype = {
        ...
        _createWidget:function(t, i) {
            ...
            this.hoverable = n();
            this.focusable = n();
            i !== this && (n.data(i, this.widgetName, this), n.data(i, this.widgetFullName, this), 
        ...
        option:function(i, r) {
            ...
            if (typeof i == "string") if (o = {}, u = i.split("."), i = u.shift(), u.length) {
                for (f = o[i] = n.widget.extend({}, this.options[i]), e = 0; e < u.length - 1; e++) f[u[e]] = f[u[e]] || {}, 
                f = f[u[e]];
        ...
        _setOption:function(n, t) {
            return this.options[n] = t, n === "disabled" && (this.widget().toggleClass(this.widgetFullName + "-disabled ui-state-disabled", !!t).attr("aria-disabled", t), 
        ...
        _on:function(t, i, r) {
            ...
            r ? (i = f = n(i), this.bindings = this.bindings.add(i)) :(r = i, i = this.element, 
            f = this.widget());
        ...
        _trigger:function(t, i, r) {
            ...
            if (r = r || {}, i = n.Event(i), i.type = (t === this.widgetEventPrefix ? t :this.widgetEventPrefix + t).toLowerCase(), 
            i.target = this.element[0], f = i.originalEvent, f) for (u in f) u in i || (i[u] = f[u]);
    ...
    n.position = {
        scrollbarWidth:function() {
            ...
            return n("body").append(i), u = e.offsetWidth, i.css("overflow", "scroll"), r = e.offsetWidth, 
            u === r && (r = i[0].clientWidth), i.remove(), f = u - r;
        },
        getScrollInfo:function(t) {
            var i = t.isWindow ? "" :t.element.css("overflow-x"), r = t.isWindow ? "" :t.element.css("overflow-y"), u = i === "scroll" || i === "auto" && t.width < t.element[0].scrollWidth, f = r === "scroll" || r === "auto" && t.height < t.element[0].scrollHeight;
            return {
    ...
    n.fn.position = function(t) {
        ...
        return k.nodeType === 9 ? (f = y.width(), l = y.height(), p = {
            top:0,
            left:0
        }) :n.isWindow(k) ? (f = y.width(), l = y.height(), p = {
            top:y.scrollTop(),
            left:y.scrollLeft()
        }) :k.preventDefault ? (t.at = "left top", f = l = 0, p = {
            top:k.pageY,
            left:k.pageX
        }) :(f = y.outerWidth(), l = y.outerHeight(), p = y.offset()), w = n.extend({}, p), 
        ...
        }), d.length === 1 && (d[1] = d[0]), t.at[0] === "right" ? w.left += f :t.at[0] === "center" && (w.left += f / 2), 
        t.at[1] === "bottom" ? w.top += l :t.at[1] === "center" && (w.top += l / 2), b = a(g.at, f, l), 
        w.left += b[0], w.top += b[1], this.each(function() {
            ...
            t.using && (it = function(n) {
                var u = p.left - o.left, v = u + f - h, e = p.top - o.top, w = e + l - c, a = {
                    target:{
                        element:y,
                        left:p.left,
                        top:p.top,
    ...
    n.ui.position = {
        ...
        flip:{
            left:function(n, t) {
                ...
                a < 0 ? (s = n.left + u + f + e + t.collisionWidth - c - y, (s < 0 || s < i(a)) && (n.left += u + f + e)) :v > 0 && (h = n.left - t.collisionPosition.marginLeft + u + f + e - o, 
            ...
            top:function(n, t) {
                ...
                s < 0 ? (l = n.top + u + f + e + t.collisionHeight - a - y, n.top + u + f + e > s && (l < 0 || l < i(s)) && (n.top += u + f + e)) :h > 0 && (c = n.top - t.collisionPosition.marginTop + u + f + e - o, 
    ...
    n.uiBackCompat !== !1 && function(n) {
        ...
        n.fn.position = function(r) {
            ...
            var u = r.offset.split(" "), f = r.at.split(" ");
            return u.length === 1 && (u[1] = u[0]), /^\d/.test(u[0]) && (u[0] = "+" + u[0]), 
            /^\d/.test(u[1]) && (u[1] = "+" + u[1]), f.length === 1 && (/left|center|right/.test(f[0]) ? f[1] = "center" :(f[1] = f[0], 
            f[0] = "center")), i.call(this, n.extend(r, {
                at:f[0] + u[0] + " " + f[1] + u[1],
                offset:t
            }));
        };
    ...
    function o(t) {
        ...
        return t.delegate(i, "mouseout", function() {
            ...
            n(this).addClass("ui-state-hover"), this.className.indexOf("ui-datepicker-prev") != -1 && n(this).addClass("ui-datepicker-prev-hover"), 
    ...
    n.extend(e.prototype, {
        ...
        _attachDatepicker:function(target, settings) {
            ...
            for (attrName in this._defaults) if (attrValue = target.getAttribute("date:" + attrName), 
            attrValue) {
        ...
        _connectDatepicker:function(t, r) {
            var u = n(t);
            (r.append = n([]), r.trigger = n([]), u.hasClass(this.markerClassName)) || (this._attachments(u, r), 
        ...
        _attachments:function(t, i) {
            ...
            (u == "button" || u == "both") && (r = this._get(i, "buttonText"), f = this._get(i, "buttonImage"), 
            i.trigger = n(this._get(i, "buttonImageOnly") ? n("<img/>").addClass(this._triggerClass).attr({
                ...
                n.datepicker._showDatepicker(t[0])) :n.datepicker._showDatepicker(t[0]), !1;
            }));
        },
        _autoSize:function(n) {
            var t, i, r;
            this._get(n, "autoSize") && !n.inline && (t = new Date(2009, 11, 20), i = this._get(n, "dateFormat"), 
            i.match(/[DM]/) && (r = function(n) {
                for (var i = 0, r = 0, t = 0; t < n.length; t++) n[t].length > i && (i = n[t].length, 
                r = t);
                return r;
        ...
        _inlineDatepicker:function(t, r) {
            ...
            u.hasClass(this.markerClassName) || (u.addClass(this.markerClassName).append(r.dpDiv).bind("setData.datepicker", function(n, t, i) {
                ...
                return this._get(r, t);
            }), n.data(t, i, r), this._setDate(r, this._getDefaultDate(r), !0), this._updateDatepicker(r), 
            this._updateAlternate(r), r.settings.disabled && this._disableDatepicker(t), r.dpDiv.css("display", "block"));
        },
        _dialogDatepicker:function(t, r, f, e, o) {
            var s = this._dialogInst, h;
            if (s || (this.uuid += 1, h = "dp" + this.uuid, this._dialogInput = n('<input type="text" id="' + h + '" style="position: absolute; top: -100px; width: 0px;"/>'), 
            this._dialogInput.keydown(this._doKeyDown), n("body").append(this._dialogInput), 
            s = this._dialogInst = this._newInst(this._dialogInput, !1), s.settings = {}, n.data(this._dialogInput[0], i, s)), 
            u(s.settings, e || {}), r = r && r.constructor == Date ? this._formatDate(s, r) :r, 
            ...
            s.settings.onSelect = f, this._inDialog = !0, this.dpDiv.addClass(this._dialogClass), 
            this._showDatepicker(this._dialogInput[0]), n.blockUI && n.blockUI(this.dpDiv), 
            n.data(this._dialogInput[0], i, s), this;
        },
        _destroyDatepicker:function(t) {
            var u = n(t), f = n.data(t, i), r;
            u.hasClass(this.markerClassName) && (r = t.nodeName.toLowerCase(), n.removeData(t, i), 
            r == "input" ? (f.append.remove(), f.trigger.remove(), u.removeClass(this.markerClassName).unbind("focus", this._showDatepicker).unbind("keydown", this._doKeyDown).unbind("keypress", this._doKeyPress).unbind("keyup", this._doKeyUp)) :(r == "div" || r == "span") && u.removeClass(this.markerClassName).empty());
        },
        _enableDatepicker:function(t) {
            var f = n(t), e = n.data(t, i), r, u;
            f.hasClass(this.markerClassName) && (r = t.nodeName.toLowerCase(), r == "input" ? (t.disabled = !1, 
            e.trigger.filter("button").each(function() {
                this.disabled = !1;
            }).end().filter("img").css({
                opacity:"1.0",
                cursor:""
            })) :(r == "div" || r == "span") && (u = f.children("." + this._inlineClass), u.children().removeClass("ui-state-disabled"), 
        ...
        _disableDatepicker:function(t) {
            var f = n(t), e = n.data(t, i), r, u;
            f.hasClass(this.markerClassName) && (r = t.nodeName.toLowerCase(), r == "input" ? (t.disabled = !0, 
            e.trigger.filter("button").each(function() {
                this.disabled = !0;
            }).end().filter("img").css({
                opacity:"0.5",
                cursor:"default"
            })) :(r == "div" || r == "span") && (u = f.children("." + this._inlineClass), u.children().addClass("ui-state-disabled"), 
        ...
        _doKeyDown:function(t) {
            ...
            if (i._keyEvent = !0, n.datepicker._datepickerShowing) switch (t.keyCode) {
              ...
              case 13:
                ...
                f = n.datepicker._get(i, "onSelect"), f ? (o = n.datepicker._formatDate(i), f.apply(i.input ? i.input[0] :null, [ o, i ])) :n.datepicker._hideDatepicker(), 
                !1;
        ...
        _doKeyPress:function(i) {
            ...
            u = String.fromCharCode(i.charCode == t ? i.keyCode :i.charCode), i.ctrlKey || i.metaKey || u < " " || !r || r.indexOf(u) > -1;
        },
        _doKeyUp:function(t) {
        ...
        _showDatepicker:function(t) {
            var i, o, s, f, e;
            if ((t = t.target || t, t.nodeName.toLowerCase() != "input" && (t = n("input", t.parentNode)[0]), 
            ...
            o = n.datepicker._get(i, "beforeShow"), s = o ? o.apply(t, [ t, i ]) :{}, s !== !1) && (u(i.settings, s), 
            i.lastVal = null, n.datepicker._lastInput = t, n.datepicker._setDateFromField(i), 
            n.datepicker._inDialog && (t.value = ""), n.datepicker._pos || (n.datepicker._pos = n.datepicker._findPos(t), 
            n.datepicker._pos[1] += t.offsetHeight), f = !1, n(t).parents().each(function() {
        ...
        _updateDatepicker:function(t) {
            ...
            var u = this._getNumberOfMonths(t), e = u[1];
        ...
        _checkOffset:function(t, i, r) {
            ...
            return i.left -= this._get(t, "isRTL") ? u - h :0, i.left -= r && i.left == t.input.offset().left ? n(document).scrollLeft() :0, 
            i.top -= r && i.top == t.input.offset().top + o ? n(document).scrollTop() :0, i.left -= Math.min(i.left, i.left + u > e && e > u ? Math.abs(i.left + u - e) :0), 
            i.top -= Math.min(i.top, i.top + f > s && s > f ? Math.abs(f + o) :0), i;
        },
        _findPos:function(t) {
        ...
        _gotoToday:function(t) {
            ...
            i.drawYear = i.selectedYear = i.currentYear) :(r = new Date(), i.selectedDay = r.getDate(), 
            i.drawMonth = i.selectedMonth = r.getMonth(), i.drawYear = i.selectedYear = r.getFullYear());
        ...
        _selectDay:function(t, i, r, u) {
            ...
            f.selectedDay = f.currentDay = n("a", u).html(), f.selectedMonth = f.currentMonth = i, 
            f.selectedYear = f.currentYear = r, this._selectDate(t, this._formatDate(f, f.currentDay, f.currentMonth, f.currentYear)));
        },
        ...
        _selectDate:function(t, i) {
            ...
            typeof r.input[0] != "object" && r.input.focus(), this._lastInput = null);
        },
        ...
        iso8601Week:function(n) {
            ...
            return t.setDate(t.getDate() + 4 - (t.getDay() || 7)), i = t.getTime(), t.setMonth(0), 
            t.setDate(1), Math.floor(Math.round((i - t) / 864e5) / 7) + 1;
        },
        parseDate:function(t, i, r) {
            ...
            var d = (r ? r.dayNamesShort :null) || this._defaults.dayNamesShort, g = (r ? r.dayNames :null) || this._defaults.dayNames, nt = (r ? r.monthNamesShort :null) || this._defaults.monthNamesShort, tt = (r ? r.monthNames :null) || this._defaults.monthNames, f = -1, o = -1, h = -1, v = -1, y = !1, a = function(n) {
                var i = s + 1 < t.length && t.charAt(s + 1) == n;
                return i && s++, i;
            }, l = function(n) {
                var r = a(n), u = n == "@" ? 14 :n == "!" ? 20 :n == "y" && r ? 4 :n == "o" ? 3 :2, f = new RegExp("^\\d{1," + u + "}"), t = i.substring(e).match(f);
                ...
                if (n.each(o, function(n, t) {
                    var r = t[1];
                    if (i.substr(e, r.length).toLowerCase() == r.toLowerCase()) return f = t[0], e += r.length, 
                    !1;
                }), f != -1) return f + 1;
            ...
            for (s = 0; s < t.length; s++) if (y) t.charAt(s) != "'" || a("'") ? p() :y = !1; else switch (t.charAt(s)) {
              case "d":
                h = l("d");
                break;
        ...
        _determineDate:function(t, i, r) {
            ...
            return u = u && u.toString() == "Invalid Date" ? r :u, u && (u.setHours(0), u.setMinutes(0), 
            u.setSeconds(0), u.setMilliseconds(0)), this._daylightSavingAdjust(u);
        },
        ...
        _generateHTML:function(t) {
            ...
            var e = this._get(t, "isRTL"), fi = this._get(t, "showButtonPanel"), pt = this._get(t, "hideIfNoPrevNext"), tt = this._get(t, "navigationAsDateFormat"), o = this._getNumberOfMonths(t), ei = this._get(t, "showCurrentAtPos"), wt = this._get(t, "stepMonths"), it = o[0] != 1 || o[1] != 1, rt = this._daylightSavingAdjust(t.currentDay ? new Date(t.currentYear, t.currentMonth, t.currentDay) :new Date(9999, 9, 9)), y = this._getMinMaxDate(t, "min"), a = this._getMinMaxDate(t, "max"), i = t.drawMonth - ei, u = t.drawYear;
            if (i < 0 && (i += 12, u--), a) for (d = this._daylightSavingAdjust(new Date(a.getFullYear(), a.getMonth() - o[0] * o[1] + 1, a.getDate())), 
            d = y && d < y ? y :d; this._daylightSavingAdjust(new Date(u, i, 1)) > d; ) i--, 
            i < 0 && (i = 11, u--);
            t.drawMonth = i;
            t.drawYear = u;
            ...
            var bt = this._canAdjustMonth(t, 1, u, i) ? '<a class="ui-datepicker-next ui-corner-all" data-handler="next" data-event="click" title="' + c + '"><span class="ui-icon ui-icon-circle-triangle-' + (e ? "w" :"e") + '">' + c + "</span></a>" :pt ? "" :'<a class="ui-datepicker-next ui-corner-all ui-state-disabled" title="' + c + '"><span class="ui-icon ui-icon-circle-triangle-' + (e ? "w" :"e") + '">' + c + "</span></a>", g = this._get(t, "currentText"), kt = this._get(t, "gotoCurrent") && t.currentDay ? rt :l;
            g = tt ? this.formatDate(g, kt, this._getFormatConfig(t)) :g;
            var dt = t.inline ? "" :'<button type="button" class="ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all" data-handler="hide" data-event="click">' + this._get(t, "closeText") + "</button>", oi = fi ? '<div class="ui-datepicker-buttonpane ui-widget-content">' + (e ? dt :"") + (this._isInRange(t, kt) ? '<button type="button" class="ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all" data-handler="today" data-event="click">' + g + "</button>" :"") + (e ? "" :dt) + "</div>" :"", v = parseInt(this._get(t, "firstDay"), 10);
            v = isNaN(v) ? 0 :v;
            var gt = this._get(t, "showWeek"), si = this._get(t, "dayNames"), vi = this._get(t, "dayNamesShort"), hi = this._get(t, "dayNamesMin"), ci = this._get(t, "monthNames"), li = this._get(t, "monthNamesShort"), ni = this._get(t, "beforeShowDay"), ft = this._get(t, "showOtherMonths"), ai = this._get(t, "selectOtherMonths"), yi = this._get(t, "calculateWeek") || this.iso8601Week, ti = this._getDefaultDate(t), et = "";
            for (p = 0; p < o[0]; p++) {
                for (ot = "", this.maxRows = 4, w = 0; w < o[1]; w++) {
                    var ii = this._daylightSavingAdjust(new Date(u, i, t.selectedDay)), b = " ui-corner-all", f = "";
                    if (it) {
                    ...
                    s = 0; s < 7; s++) ht = (s + v) % 7, st += "<th" + ((s + v + 6) % 7 >= 5 ? ' class="ui-datepicker-week-end"' :"") + '><span title="' + si[ht] + '">' + hi[ht] + "</span></th>";
                    f += st + "</tr></thead><tbody>";
                    ct = this._getDaysInMonth(u, i);
                    u == t.selectedYear && i == t.selectedMonth && (t.selectedDay = Math.min(t.selectedDay, ct));
                    var ri = (this._getFirstDayOfMonth(u, i) - v + 7) % 7, lt = Math.ceil((ri + ct) / 7), ui = it ? this.maxRows > lt ? this.maxRows :lt :lt;
                    for (this.maxRows = ui, r = this._daylightSavingAdjust(new Date(u, i, 1 - ri)), 
                    at = 0; at < ui; at++) {
                        for (f += "<tr>", vt = gt ? '<td class="ui-datepicker-week-col">' + this._get(t, "calculateWeek")(r) + "</td>" :"", 
                        s = 0; s < 7; s++) {
                            var nt = ni ? ni.apply(t.input ? t.input[0] :null, [ r ]) :[ !0, "" ], k = r.getMonth() != i, yt = k && !ai || !nt[0] || y && r < y || a && r > a;
        ...
        _generateMonthYearHeader:function(n, t, i, r, u, f, e, o) {
            ...
            if (f || !v) l += '<span class="ui-datepicker-month">' + e[t] + "</span>"; else {
                for (w = r && r.getFullYear() == i, b = u && u.getFullYear() == i, l += '<select class="ui-datepicker-month" data-handler="selectMonth" data-event="change">', 
                h = 0; h < 12; h++) (!w || h >= r.getMonth()) && (!b || h <= u.getMonth()) && (l += '<option value="' + h + '"' + (h == t ? ' selected="selected"' :"") + ">" + o[h] + "</option>");
                l += "</select>";
            }
            if (p || (c += l + (f || !(v && y) ? "&#xa0;" :"")), !n.yearshtml) if (n.yearshtml = "", 
            f || !y) c += '<span class="ui-datepicker-year">' + i + "</span>"; else {
                var k = this._get(n, "yearRange").split(":"), d = new Date().getFullYear(), g = function(n) {
                    var t = n.match(/c[+-].*/) ? i + parseInt(n.substring(1), 10) :n.match(/[+-].*/) ? d + parseInt(n, 10) :parseInt(n, 10);
                    return isNaN(t) ? d :t;
                }, s = g(k[0]), a = Math.max(s, g(k[1] || ""));
                for (s = r ? Math.max(s, r.getFullYear()) :s, a = u ? Math.min(a, u.getFullYear()) :a, 
                n.yearshtml += '<select class="ui-datepicker-year" data-handler="selectYear" data-event="change">'; s <= a; s++) n.yearshtml += '<option value="' + s + '"' + (s == i ? ' selected="selected"' :"") + ">" + s + "</option>";
                n.yearshtml += "</select>";
                c += n.yearshtml;
                n.yearshtml = null;
            }
            return c += this._get(n, "yearSuffix"), p && (c += (f || !(v && y) ? "&#xa0;" :"") + l), 
            c + "</div>";
        },
    ...
    n.widget("ui.tabs", {
        ...
        _create:function() {
            var u = this, i = this.options, t = i.active, r = location.hash.substring(1);
            this.running = !1;
            ...
            }), t === null && (t = this.tabs.index(this.tabs.filter(".ui-tabs-active"))), (t === null || t === -1) && (t = this.tabs.length ? 0 :!1));
        ...
        _tabKeydown:function(t) {
            ...
            if (!this._handlePageNav(t)) {
                ...
                t.ctrlKey || (r.attr("aria-selected", "false"), this.tabs.eq(i).attr("aria-selected", "true"), 
        ...
        _processTabs:function() {
            ...
            this.anchors.each(function(i, r) {
                ...
                u(r) ? (e = r.hash, f = t.element.find(t._sanitizeSelector(e))) :(s = t._tabId(o), 
                e = "#" + s, f = t.element.find(e), f.length || (f = t._createPanel(s), f.insertAfter(t.panels[i - 1] || t.tablist)), 
        ...
        _setupHeightStyle:function(t) {
            ...
            t === "fill" ? (n.support.minHeight || (u = r.css("overflow"), r.css("overflow", "hidden")), 
            i = r.height(), this.element.siblings(":visible").each(function() {
        ...
        _eventHandler:function(t) {
            ...
            this.active = f ? n() :i, this.xhr && this.xhr.abort(), s.length || o.length || n.error("jQuery UI Tabs: Mismatching fragment identifier."), 
        ...
        _toggle:function(t, i) {
            ...
            f.length && this.options.hide ? this._hide(f, this.options.hide, function() {
                ...
                o();
            }) :(i.oldTab.closest("li").removeClass("ui-tabs-active ui-state-active"), f.hide(), 
            o());
            f.attr({
                "aria-expanded":"false",
                "aria-hidden":"true"
        ...
        _activate:function(t) {
            ...
            i[0] !== this.active[0] && (i.length || (i = this.active), r = i.find(".ui-tabs-anchor")[0], 
            this._eventHandler({
                target:r,
                currentTarget:r,
        ...
        load:function(t, i) {
            t = this._getIndex(t);
            var f = this, r = this.tabs.eq(t), o = r.find(".ui-tabs-anchor"), e = this._getPanelForTab(r), s = {
                tab:r,
                panel:e
            };
            u(o[0]) || (this.xhr = n.ajax(this._ajaxSettings(o, i, s)), this.xhr && this.xhr.statusText !== "canceled" && (r.addClass("ui-tabs-loading"), 
            e.attr("aria-busy", "true"), this.xhr.success(function(n) {
                setTimeout(function() {
                    e.html(n);
                    f._trigger("load", i, s);
                }, 1);
    ...
    n.uiBackCompat !== !1 && (n.ui.tabs.prototype._ui = function(n, t) {
            ...
            this._on({
                tabsbeforeload:function(n, t) {
                    if (n.target === this.element[0] && this.options.spinner) {
                        var i = t.tab.find("span"), r = i.html();
        ...
        add:function(i, r, u) {
            ...
            e.attr("aria-controls", h), s = u >= this.tabs.length, f = this.element.find("#" + h), 
            f.length || (f = this._createPanel(h), s ? u > 0 ? f.insertAfter(this.panels.eq(-1)) :f.appendTo(this.element) :f.insertBefore(this.panels[u])), 
            f.addClass("ui-tabs-panel ui-widget-content ui-corner-bottom").hide(), s ? e.appendTo(this.tablist) :e.insertBefore(this.tabs[u]), 
            o.disabled = n.map(o.disabled, function(n) {
                return n >= u ? ++n :n;
            }), this.refresh(), this.tabs.length === 1 && o.active === !1 && this.option("active", 0), 
            this._trigger("add", null, this._ui(this.anchors[u], this.panels[u])), this;
        },
        remove:function(t) {
            t = this._getIndex(t);
            var r = this.options, i = this.tabs.eq(t).remove(), u = this._getPanelForTab(i).remove();
            ...
            r.disabled = n.map(n.grep(r.disabled, function(n) {
                ...
                return n >= t ? --n :n;
            }), this.refresh(), this._trigger("remove", null, this._ui(i.find("a")[0], u[0])), 
            this;
        }
    }), n.widget("ui.tabs", n.ui.tabs, {
        length:function() {
        ...
        _tabId:function(t) {
            ...
            return i = i[0], n(i).closest("li").attr("aria-controls") || i.title && i.title.replace(/\s/g, "_").replace(/[^\w\u00c0-\uFFFF\-]/g, "") || this.options.idPrefix + r();
        }
    }), n.widget("ui.tabs", n.ui.tabs, {
        options:{
        ...
        _trigger:function(n, t, i) {
            ...
            f = i.newPanel.length ? i.newPanel :i.oldPanel, r = this._super("select", t, {
        ...
        select:function(n) {
            if (n = this._getIndex(n), n === -1) if (this.options.collapsible && this.options.selected !== -1) n = this.options.selected; else return;
        ...
        n.widget("ui.tabs", n.ui.tabs, {
            ...
            _create:function() {
                ...
                t.active == null && t.cookie && (n = parseInt(this._cookie(), 10), n === -1 && (n = !1), 
                t.active = n);
                this._super();
            },
            _cookie:function(i) {
        ...
        _getFx:function() {
            ...
            return t && (n.isArray(t) ? (i = t[0], r = t[1]) :i = r = t), t ? {
                show:r,
                hide:i
            } :null;
        },
        _toggle:function(n, t) {
            ...
            var r = this, u = t.newPanel, f = t.oldPanel, i = this._getFx();
            ...
            f.length && i.hide ? f.animate(i.hide, i.hide.duration, function() {
                ...
                o();
            }) :(t.oldTab.closest("li").removeClass("ui-tabs-active ui-state-active"), f.hide(), 
            o());
        }
    }));
}(jQuery);
...
jQuery.effects || function(n, t) {
    var i = n.uiBackCompat !== !1, r = "ui-effects-";
    n.effects = {
        effect:{}
    }, function(t, i) {
        function o(n, t, i) {
        ...
        function a(n) {
            var i = r(), o = i._rgba = [];
            return (n = n.toLowerCase(), u(p, function(t, r) {
                var u, s = r.re.exec(n), h = s && r.parse(s), e = r.space || "rgba";
                if (h) return u = i[e](h), i[f[e].cache] = u[f[e].cache], o = i._rgba = u._rgba, 
                !1;
            }), o.length) ? (o.join() === "0,0,0,0" && t.extend(o, e.transparent), i) :e[n];
        }
        function s(n, t, i) {
        ...
        r.fn = t.extend(r.prototype, {
            parse:function(s, h, c, l) {
                ...
                (s.jquery || s.nodeType) && (s = t(s).css(h), h = i);
                var v = this, y = t.type(s), p = this._rgba = [];
                return (h !== i && (s = [ s, h, c, l ], y = "array"), y === "string") ? this.parse(a(s) || e._default) :y === "array" ? (u(f.rgba.props, function(n, t) {
                    p[t.idx] = o(s[t.idx], t);
            ...
            is:function(n) {
                var e = r(n), t = !0, i = this;
                return u(f, function(n, r) {
                    var o, f = e[r.cache];
                    return f && (o = i[r.cache] || r.to && r.to(i._rgba) || [], u(r.props, function(n, i) {
            ...
            transition:function(n, t) {
                var i = r(n), c = i._space(), e = f[c], l = this.alpha() === 0 ? r("transparent") :this, a = l[e.cache] || e.to(l._rgba), s = a.slice();
                return i = i[e.cache], u(e.props, function(n, r) {
                    var c = r.idx, u = a[c], f = i[c], e = h[r.type] || {};
            ...
            blend:function(n) {
                ...
                var i = this._rgba.slice(), u = i.pop(), f = r(n)._rgba;
                return r(t.map(i, function(n, t) {
                    return (1 - u) * f[t] + u * n;
                }));
            },
            toRgbaString:function() {
                var i = "rgba(", n = t.map(this._rgba, function(n, t) {
                    return n == null ? t > 2 ? 1 :0 :n;
                });
                return n[3] === 1 && (n.pop(), i = "rgb("), i + n.join() + ")";
            },
            toHslaString:function() {
                var i = "hsla(", n = t.map(this.hsla(), function(n, t) {
                    return n == null && (n = t > 2 ? 1 :0), t && t < 3 && (n = Math.round(n * 100) + "%"), 
                    n;
                });
                return n[3] === 1 && (n.pop(), i = "hsl("), i + n.join() + ")";
            },
            toHexString:function(n) {
                var i = this._rgba.slice(), r = i.pop();
                return n && i.push(~~(r * 255)), "#" + t.map(i, function(n) {
        ...
        f.hsla.to = function(n) {
            ...
            l = f === 0 || f === 1 ? f :f <= .5 ? u / s :u / (2 - s), [ Math.round(c) % 360, l, f, h == null ? 1 :h ];
        };
        ...
        u(f, function(n, f) {
            var s = f.props, e = f.cache, h = f.to, c = f.from;
            r.fn[n] = function(n) {
                if (h && !this[e] && (this[e] = h(this._rgba)), n === i) return this[e].slice();
                var l, a = t.type(n), v = a === "array" || a === "object" ? n :arguments, f = this[e].slice();
                return u(s, function(n, t) {
                    var i = v[a === "object" ? n :t.idx];
                    i == null && (i = f[t.idx]);
                    f[t.idx] = o(i, t);
                }), c ? (l = r(c(f)), l[e] = f, l) :r(f);
            };
            u(s, function(i, u) {
                r.fn[i] || (r.fn[i] = function(r) {
                    var f = t.type(r), h = i === "alpha" ? this._hsla ? "hsla" :"rgba" :n, o = this[h](), s = o[u.idx], e;
                    return f === "undefined" ? s :(f === "function" && (r = r.call(this, s), f = t.type(r)), 
                    r == null && u.empty) ? this :(f === "string" && (e = y.exec(r), e && (r = s + parseFloat(e[2]) * (e[1] === "+" ? 1 :-1))), 
                    o[u.idx] = r, this[h](o));
                });
            });
        });
            ...
            t.cssHooks[i] = {
                set:function(n, u) {
                    ...
                    if (t.type(u) !== "string" || (o = a(u))) {
                        if (u = r(o || u), !c.rgba && u._rgba[3] !== 1) {
                            for (f = i === "backgroundColor" ? n.parentNode :n; (e === "" || e === "transparent") && f && f.style; ) try {
        ...
        function i() {
            ...
            if (t && t.length && t[0] && t[t[0]]) for (u = t.length; u--; ) i = t[u], typeof t[i] == "string" && (r[n.camelCase(i)] = t[i]); else for (i in t) typeof t[i] == "string" && (r[i] = t[i]);
            return r;
        }
        function f(t, i) {
            var e = {}, r, f;
        ...
        n.effects.animateClass = function(t, u, e, o) {
            ...
            return this.queue(function() {
                ...
                o();
                u = u.map(function() {
                    return this.end = i.call(this.el[0]), this.diff = f(this.start, this.end), this;
                });
                e.attr("class", h);
                u = u.map(function() {
                    var i = this, t = n.Deferred(), r = jQuery.extend({}, s, {
                        queue:!1,
                        complete:function() {
                            t.resolve(i);
                        }
        ...
        function u(t, i, r, u) {
            return n.isPlainObject(t) && (i = t, t = t.effect), t = {
                effect:t
            }, i == null && (i = {}), n.isFunction(i) && (u = i, r = null, i = {}), (typeof i == "number" || n.fx.speeds[i]) && (u = r, 
            r = i, i = {}), n.isFunction(r) && (u = r, r = null), i && n.extend(t, i), r = r || i.duration, 
        ...
        n.extend(n.effects, {
            ...
            restore:function(n, i) {
                for (var f, u = 0; u < i.length; u++) i[u] !== null && (f = n.data(r + i[u]), f === t && (f = ""), 
                n.css(i[u], f));
            },
            ...
            createWrapper:function(t) {
                ...
                return t.wrap(u), (t[0] === r || n.contains(t[0], r)) && n(r).focus(), u = t.parent(), 
        ...
        n.fn.extend({
            effect:function() {
                function s(i) {
                    ...
                    var u = n(this), f = t.complete, e = t.mode;
                    (u.is(":hidden") ? e === "hide" :e === "show") ? o() :r.call(u[0], t, o);
                }
                var t = u.apply(this, arguments), f = t.mode, e = t.queue, r = n.effects.effect[t.effect], o = !r && i && n.effects[t.effect];
    ...
    TrimPath.parseTemplate = function(n, t, i) {
        ...
        var r = u(n, t, i), f = TrimPath.evalEx(r, t, 1);
    ...
    TrimPath.parseTemplate_etc.statementDef = {
        ...
        "for":{
            ...
            prefixFunc:function(n, t, i, r) {
                if (n[2] != "in") throw new r.ParseError(i, t.line, "bad for loop statement: " + n.join(" "));
                var u = n[1], f = "__LIST__" + u;
    ...
    TrimPath.parseTemplate_etc.Template = function(n, t, i, r, u) {
        this.process = function(n, t) {
            ...
            for (f in u.modifierDef) n._MODIFIERS[f] == null && (n._MODIFIERS[f] = u.modifierDef[f]);
            t == null && (t = {});
            e = [];
            s = {
                write:function(n) {
            ...
            try {
                ...
                if (t.throwExceptions == !0) throw i;
    ...
    var u = function(i, r, u) {
        ...
        for (var h = [ "var TrimPath_Template_TEMP = function(_OUT, _CONTEXT, _FLAGS) { with (_CONTEXT) {" ], p = {
            ...
            for (e = c, e = i.indexOf("{", e + 1); e >= 0; ) {
                var l = i.indexOf("}", e + 1), nt = i.substring(e, l), g = nt.match(/^\{(cdata|minify|eval)/);
                if (g) {
                    var v = g[1], b = e + v.length + 1, y = i.indexOf("}", b);
                    y >= 0 && (k = y - b <= 0 ? "{/" + v + "}" :i.substring(b + 1, y), w = i.indexOf(k, y + 1), 
                    w >= 0 && (n(i.substring(c + 1, e), h), a = i.substring(y + 1, w), v == "cdata" ? t(a, h) :v == "minify" ? t(s(a), h) :v == "eval" && a != null && a.length > 0 && h.push("_OUT.write( (function() { " + a + " })() );"), 
                    e = c = w + k.length - 1));
                } else if (i.charAt(e - 1) != "$" && i.charAt(e - 1) != "\\" && (d = i.charAt(e + 1) == "/" ? 2 :1, 
                i.substring(e + d, e + 10 + d).search(TrimPath.parseTemplate_etc.statementTag) == 0)) break;
                e = i.indexOf("{", e + 1);
            }
            if (e < 0) break;
            if (l = i.indexOf("}", e + 1), l < 0) break;
            n(i.substring(c + 1, e), h);
            f(i.substring(e, l + 1), p, h, r, u);
            c = l;
        }
        if (n(i.substring(c + 1), h), p.stack.length != 0) throw new u.ParseError(r, p.line, "unclosed, unmatched statement(s): " + p.stack.join(","));
        return h.push("}}; TrimPath_Template_TEMP"), h.join("");
        ...
        if (e.delta < 0) {
            if (i.stack.length <= 0) throw new f.ParseError(u, i.line, "close tag does not match any previous statement: " + t);
            i.stack.pop();
        }
        if (e.delta > 0 && i.stack.push(t), e.paramMin != null && e.paramMin >= o.length) throw new f.ParseError(u, i.line, "statement needs more parameters: " + t);
        if (e.prefixFunc != null ? r.push(e.prefixFunc(o, i, u, f)) :r.push(e.prefix), e.suffix != null) {
            if (o.length <= 1) e.paramDefault != null && r.push(e.paramDefault); else for (s = 1; s < o.length; s++) s > 1 && r.push(" "), 
            r.push(o[s]);
            r.push(e.suffix);
        }
    }, n = function(n, t) {
        var u, r, o, f, i;
        if (!(n.length <= 0)) {
            for (u = 0, r = n.length - 1; u < n.length && n.charAt(u) == "\n"; ) u++;
            while (r >= 0 && (n.charAt(r) == " " || n.charAt(r) == "    ")) r--;
            for (r < u && (r = u), u > 0 && (t.push('if (_FLAGS.keepWhitespace == true) _OUT.write("'), 
            i = n.substring(0, u).replace("\n", "\\n"), i.charAt(i.length - 1) == "\n" && (i = i.substring(0, i.length - 1)), 
            t.push(i), t.push('");')), o = n.substring(u, r + 1).split("\n"), f = 0; f < o.length; f++) e(o[f], t), 
        ...
        for (var f = "}", e = -1, h, u, c; e + f.length < n.length; ) {
            var s = "${", l = "}", o = n.indexOf(s, e + f.length);
            if (o < 0) break;
            if (n.charAt(o + 2) == "%" && (s = "${%", l = "%}"), h = n.indexOf(l, o + s.length), 
            h < 0) break;
            t(n.substring(e + f.length, o), r);
            u = n.substring(o + s.length, h).replace(/\|\|/g, "#@@#").split("|");
            for (c in u) u[c].replace && (u[c] = u[c].replace(/#@@#/g, "||"));
            r.push("_OUT.write(");
            i(u, u.length - 1, r);
            r.push(");");
            e = h;
        ...
        n = n.replace(/"/g, '\\"'), t.push('_OUT.write("'), t.push(n), t.push('");'));
    }, i = function(n, t, r) {
        var f = n[t], u;
        if (t <= 0) {
            r.push(f);
        ...
        r.push('"](');
        i(n, t - 1, r);
        u.length > 1 && (r.push(","), r.push(u[1]));
        r.push(")");
    }, o = function(n) {
        return n = n.replace(/\t/g, "    "), n = n.replace(/\r\n/g, "\n"), n = n.replace(/\r/g, "\n"), 
        n.replace(/^(\s*\S*(\s+\S+)*)\s*$/, "$1");
    }, s = function(n) {
        return n = n.replace(/^\s+/g, ""), n = n.replace(/\s+$/g, ""), n = n.replace(/\s+/g, " "), 
        n.replace(/^(\s*\S*(\s+\S+)*)\s*$/, "$1");
    };
    TrimPath.parseDOMTemplate = function(n, t, i) {
        t == null && (t = document);
        var u = t.getElementById(n), r = u.value;
        return r == null && (r = u.innerHTML), r = r.replace(/&lt;/g, "<").replace(/&gt;/g, ">"), 
    ...
    n.widget("ui.dropdown", {
        ...
        _create:function() {
            ...
            (t.push(i), (!jQuery().dropShadow || isIE8AndBelow) && (r.dropShadow = !1), r.contentId) && (this._popupRoot = n("#" + r.contentId), 
            this._popupRoot.css({
                position:"absolute",
                display:"block",
                visibility:"hidden",
                zIndex:r.zIndex
            }), this._delayhide = !1, this._delayShow = !1, this._isHiding = !1, this._isShowing = !1, 
            this._isShowed = !1, r.triggerEvent == "click" ? (i.element.mousedown(function() {
                if (t) for (var n = 0; n < t.length; n++) (t[n]._isShowed || t[n]._isShowing) && t[n] != i && t[n].hide(!0);
                ...
                i._hidePopupTimeOut();
            }), r.moveToRoot && this._popupRoot.appendTo(document.body), this._popupRoot.attr("_h", this._popupRoot.outerHeight()), 
            this._popupRoot.attr("_w", this._popupRoot.outerWidth()), this._popupRoot.css({
                display:"none",
                visibility:"visible"
            }), this.hide(!0), n(document).mousedown(function(t) {
                var u = n(t.target);
            ...
            }), u = null, n(window).bind("resize scroll", function() {
                (i._isShowing || i._isShowed) && (i._popupRoot.stop(!0, !0), u && clearTimeout(u), 
        ...
        show:function() {
            ...
            if (!t.element.attr("disabled") && (t._delayShow = t._isHiding, !t._isHiding && !t._isShowing && !t._isShowed)) if (u = t._setPosition(), 
            r = function() {
                ...
                }), t._isShowing && (t._popupRoot.attr("_h", t._popupRoot.outerHeight()), t._popupRoot.attr("_w", t._popupRoot.outerWidth()), 
                i.onShowed && n.isFunction(i.onShowed))) i.onShowed(t);
                t._isShowing = !1;
                t._isShowed = !0;
                t._isHiding = !1;
                t._delayHide && t.hide();
            }, t._isShowing = !0, i.show && i.show != "auto" && i.show != "animate") t._popupRoot.show(i.show, i.showEffectOptions, i.showSpd, r); else if (i.show == "animate") t._popupRoot.animate(i.showEffectOptions, i.showSpd, r); else if (i.autoPos && (i.autoPos == "left-top" || i.autoPos == "right-top")) {
                var f = this.element, e = f.offset(), o = this._popupRoot;
                t._popupRoot.animate({
                    top:e.top - o.outerHeight(),
                    height:"toggle"
                }, i.showSpd, r);
            } else t._popupRoot.slideDown(i.showSpd, r);
        },
        hide:function(t) {
            var i = this, r = this.options, f, u, e, o;
            (i._delayHide = i._isShowing, i._isHiding || !i._isShowed || i._isShowing) || (r.dropShadow && i._isShowed && (f = i._popupRoot.shadowId(), 
            f && n("#" + f).hide()), u = function() {
                if (r.onHidden && n.isFunction(r.onHidden)) r.onHidden(i);
                ...
                i._isHiding = !1;
                i._delayShow && i.show();
            }, i._isHiding = !0, r.hide && r.hide != "auto" && r.hide != "animate" ? i._popupRoot.hide(r.hide, r.hideEffectOptions, r.hideSpd, u) :r.hide == "animate" ? i._popupRoot.animate(r.hideEffectOptions, r.hideSpd, u) :r.autoPos && (r.autoPos == "left-top" || r.autoPos == "right-top") ? (e = this.element, 
            o = e.offset(), i._popupRoot.animate({
                height:"toggle",
                top:o.top
            }, r.showSpd, u)) :i._popupRoot.slideUp(r.showSpd, u), t && i._popupRoot.stop(!0, !0));
        },
        _setPosition:function() {
            ...
            if (t.autoWidth && (s = f.outerWidth(), e.outerWidth() < s && e.css({
                width:s
            })), t.popupAdjust && (t.popupAdjust.left && (u.left = t.popupAdjust.left), t.popupAdjust.top && (u.top = t.popupAdjust.top), 
            t.popupAdjust.right && (u.right = t.popupAdjust.right), t.popupAdjust.bottom && (u.bottom = t.popupAdjust.bottom)), 
            r = null, i = t.position ? t.position :"left-bottom", i == "auto") {
                var h = n(window).height(), c = n(window).width(), l = n(window).scrollTop(), a = n(window).scrollLeft(), v = parseInt(e.attr("_w")), y = parseInt(e.attr("_h"));
                i = "left";
            ...
            return r == null && (r = this._calPosition(i, o, f, u, t)), e.css(r), r;
        },
    ...
    n.widget("ui.floating", {
        ...
        _init:function() {
            var r = this, t = this.options, i = this.element;
            this.udata = null;
        ...
        _windowScroll:function() {
            var i = n(window).scrollTop(), t = n(window).scrollLeft();
            (this.windowSize.t != i || this.windowSize.l != t) && (this.windowSize.t = i, this.windowSize.l != t && (this.o.left = this._getOffset().left - t, 
            this.windowSize.l = t), this._floating(t, i), this.onWindowScroll());
        },
        ...
        _windowResize:function() {
            var r = n(window).height(), i = n(window).width(), u = n(window).scrollTop(), f = this.options, t = this;
            ...
            this._to = setTimeout(function() {
                if (!t._isDestroyed) {
                    ...
                    f < 0 && (f = 0)), t.o.left = t._getOffset().left - f);
                    t.windowSize.l = f;
                    t.windowSize.h = r;
                    t.windowSize.w = i;
                    t.windowSize.t = u;
        ...
        onWindowResize:function() {
            var n = this;
            if (n.options.onSized) n.options.onSized({
        ...
        onWindowScroll:function() {
            if (this.options.onScrolled) this.options.onScrolled({
                window:this.windowSize,
                isF:this._isFloating,
                element:this.element,
                oTop:this.o.top
        ...
        updateDummySize:function(n, t) {
            this.options.displayDummy != "none" && (n && this.options.dummy.width(n), t && this.options.dummy.height(t));
        },
        _floating:function(t, i) {
            var r, o;
            if (!this._isDestroyed) {
                var u = this.options, e = this.o, f = this.element, s = f.height();
                if (i == null && (i = n(window).scrollTop()), i + u.top >= e.top && i != 0) {
                    if (!this._isFloating) {
                        if (r = {
                            data:this.udata,
                            element:f,
                            ...
                            elWidth:f.width(),
                            isF:this._isFloating
                        }, u.onFloat && n.isFunction(u.onFloat) && (o = u.onFloat(r), o === !1 && (r.cancel = !0), 
                        this.udata = r.data, e.top = r.oTop, e.left = r.oLeft, r.cancel)) return;
                        if (u.dummy) {
                            try {
                    ...
                    if (this._isFloating) {
                        if (r = {
                            ...
                            elWidth:f.width(),
                            isF:this._isFloating
                        }, u.onFloating && n.isFunction(u.onFloating) && (o = u.onFloating(r), o === !1 && (r.cancel = !0), 
                        this.udata = r.data, e.top = r.oTop, e.left = r.oLeft, r.cancel)) return;
        ...
        dock:function() {
            var f, e, t;
            if (this._isFloating) {
                var i = this.options, r = this.o, u = this.element;
                if (i.onDock && n.isFunction(i.onDock) && (t = {
                    ...
                    elHeight:"auto",
                    elWidth:"auto"
                }, f = i.onDock(t), f === !1 && (t.cancel = !0), r.top = t.oTop, r.left = t.oLeft, 
                this.udata = t.data), i.floatObject == "self" && (e = n.extend({}, this._css, t ? {
                    height:t.elHeight,
                    width:t.elWidth
                } :{}), u.css(e)), i.dummy && (i.dummy.remove(), i.dummy.css("display", "none")), 
                this._isFloating = !1, i.onDocked && n.isFunction(i.onDocked)) {
                    t = {
                        data:this.udata,
                        element:u,
                        dummy:i.dummy,
    ...
    function e(r) {
        ...
        if (r = n.event.fix(f), r.type = "mousewheel", "detail" in f && (e = f.detail * -1), 
        "wheelDelta" in f && (e = f.wheelDelta), "wheelDeltaY" in f && (e = f.wheelDeltaY), 
        "wheelDeltaX" in f && (o = f.wheelDeltaX * -1), "axis" in f && f.axis === f.HORIZONTAL_AXIS && (o = e * -1, 
        e = 0), l = e === 0 ? o :e, "deltaY" in f && (e = f.deltaY * -1, l = e), "deltaX" in f && (o = f.deltaX, 
        e === 0 && (l = o * -1)), e !== 0 || o !== 0) return f.deltaMode === 1 ? (v = n.data(this, "mousewheel-line-height"), 
        l *= v, e *= v, o *= v) :f.deltaMode === 2 && (y = n.data(this, "mousewheel-page-height"), 
        l *= y, e *= y, o *= y), a = Math.max(Math.abs(e), Math.abs(o)), (!t || a < t) && (t = a, 
        s(f, a) && (t /= 40)), s(f, a) && (l /= 40, o /= 40, e /= 40), l = Math[l >= 1 ? "floor" :"ceil"](l / t), 
        o = Math[o >= 1 ? "floor" :"ceil"](o / t), e = Math[e >= 1 ? "floor" :"ceil"](e / t), 
        i.settings.normalizeOffset && this.getBoundingClientRect && (p = this.getBoundingClientRect(), 
        b = r.clientX - p.left, k = r.clientY - p.top), r.deltaX = o, r.deltaY = e, r.deltaFactor = t, 
        r.offsetX = b, r.offsetY = k, r.deltaMode = 0, w.unshift(r, l, o, e), u && clearTimeout(u), 
        u = setTimeout(c, 200), (n.event.dispatch || n.event.handle).apply(this, w);
    }
    function c() {
        t = null;
    }
    ...
    if (n.event.fixHooks) for (f = o.length; f; ) n.event.fixHooks[o[--f]] = n.event.mouseHooks;
    i = n.event.special.mousewheel = {
        version:"3.1.12",
        setup:function() {
            if (this.addEventListener) for (var t = r.length; t; ) this.addEventListener(r[--t], e, !1); else this.onmousewheel = e;
            n.data(this, "mousewheel-line-height", i.getLineHeight(this));
            n.data(this, "mousewheel-page-height", i.getPageHeight(this));
        },
        teardown:function() {
            if (this.removeEventListener) for (var t = r.length; t; ) this.removeEventListener(r[--t], e, !1); else this.onmousewheel = null;
    ...
    n.fn.bxSlider = function(u) {
        ...
        var w = n(window).width(), b = n(window).height(), k = function() {
            ...
            f.usingCSS = f.settings.useCSS && "fade" != f.settings.mode && function() {
                ...
                for (t in n) if (void 0 !== i.style[n[t]]) return f.cssPrefix = n[t].replace("Perspective", "").toLowerCase(), 
                f.animProp = "-" + f.cssPrefix + "-transform", !0;
                return !1;
            }();
            ...
            f.settings.ticker ? f.settings.pager = !1 :(f.settings.pager && ht(), f.settings.controls && ct(), 
            f.settings.auto && f.settings.autoControls && lt(), (f.settings.controls || f.settings.autoControls || f.settings.pager) && f.viewport.after(f.controls.el));
            et(t, ot);
        }, et = function(t, i) {
            var r = t.find("img, iframe").length, u;
            if (0 == r) return i(), void 0;
            u = 0;
            ...
            if (f.settings.infiniteLoop && "fade" != f.settings.mode && !f.settings.ticker) {
                var t = "vertical" == f.settings.mode ? f.settings.minSlides :f.settings.maxSlides, i = f.children.slice(0, t).clone().addClass("bx-clone"), r = f.children.slice(-t).clone().addClass("bx-clone");
            ...
            var r = 0, t = n(), u;
            if ("vertical" == f.settings.mode || f.settings.adaptiveHeight) if (f.carousel) for (u = 1 == f.settings.moveSlides ? f.active.index :f.active.index * c(), 
            t = f.children.eq(u), i = 1; i <= f.settings.maxSlides - 1; i++) t = u + i >= f.children.length ? t.add(f.children.eq(i - 1)) :t.add(f.children.eq(u + i)); else t = f.children.eq(f.active.index); else t = f.children;
            ...
            var n = 0, t, i;
            if (f.settings.moveSlides > 0) if (f.settings.infiniteLoop) n = f.children.length / c(); else for (t = 0, 
            i = 0; t < f.children.length; ) ++n, t = i + h(), i += f.settings.moveSlides <= h() ? f.settings.moveSlides :h(); else n = Math.ceil(f.children.length / h());
            return n;
        }, c = function() {
            ...
            n = t.position(), o(-(n.left - (f.viewport.width() - t.width())), "reset", 0)) :"vertical" == f.settings.mode && (i = f.children.length - f.settings.minSlides, 
            n = f.children.eq(i).position(), o(-n.top, "reset", 0)) :(n = f.children.eq(f.active.index * c()).position(), 
            f.active.index == s() - 1 && (f.active.last = !0), void 0 != n && ("horizontal" == f.settings.mode ? o(-n.left, "reset", 0) :"vertical" == f.settings.mode && o(-n.top, "reset", 0)));
        }, o = function(n, t, i, r) {
            var u, s;
            f.usingCSS ? (u = "vertical" == f.settings.mode ? "translate3d(0, " + n + "px, 0)" :"translate3d(" + n + "px, 0, 0)", 
            e.css("-" + f.cssPrefix + "-transition-duration", i / 1e3 + "s"), "slide" == t ? (e.css(f.animProp, u), 
            ...
            e.css(f.animProp, u), e.bind("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd", function() {
                e.unbind("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd");
                o(r.resetValue, "reset", 0);
                a();
            }))) :(s = {}, s[f.animProp] = n, "slide" == t ? e.animate(s, i, f.settings.easing, function() {
                y();
            ...
            for (var i, r = "", u = s(), t = 0; u > t; t++) i = "", f.settings.buildPager && n.isFunction(f.settings.buildPager) ? (i = f.settings.buildPager(t), 
            f.pagerEl.addClass("bx-custom-pager")) :(i = t + 1, f.pagerEl.addClass("bx-default-pager")), 
            ...
            f.controls.directionEl.append(f.controls.prev).append(f.controls.next), f.controls.el.addClass("bx-has-controls-direction").append(f.controls.directionEl));
        }, lt = function() {
            ...
            f.settings.auto && e.stopAuto();
            var r = n(t.currentTarget), i = parseInt(r.attr("data-slide-index"));
            ...
            f.pagerEl.html(t + 1 + f.settings.pagerShortSeparator + i), void 0) :(f.pagerEl.find("a").removeClass("active"), 
            ...
            1 == s() ? (f.controls.prev.addClass("disabled"), f.controls.next.addClass("disabled")) :!f.settings.infiniteLoop && f.settings.hideControlOnEnd && (0 == f.active.index ? (f.controls.prev.addClass("disabled"), 
            ...
            t = f.children.first().position(), i = "horizontal" == f.settings.mode ? -t.left :-t.top);
            o(i, "reset", 0);
            f.settings.pager = !1;
            ...
            f.settings.tickerHover && !f.usingCSS && f.viewport.hover(function() {
                ...
                var i = f.settings.speed / t, r = "horizontal" == f.settings.mode ? "left" :"top", u = i * (t - Math.abs(parseInt(e.css(r))));
                a(u);
            });
            a();
        }, a = function(n) {
            ...
            var r = "horizontal" == f.settings.mode ? -t.left :-t.top, u = "horizontal" == f.settings.mode ? -i.left :-i.top, s = {
                resetValue:u
            };
            o(r, "ticker", speed, s);
        }, gt = function() {
            ...
            if (f.working) n.preventDefault(); else {
            ...
            "fade" != f.settings.mode && f.settings.oneToOneTouch) && (r = 0, "horizontal" == f.settings.mode ? (t = i.changedTouches[0].pageX - f.touch.start.x, 
            r = f.touch.originalPos.left + t) :(t = i.changedTouches[0].pageY - f.touch.start.y, 
            r = f.touch.originalPos.top + t), o(r, "reset", 0));
        }, rt = function(n) {
            var r, i, t;
            f.viewport.unbind("touchmove", it);
            r = n.originalEvent;
            i = 0;
            (f.touch.end.x = r.changedTouches[0].pageX, f.touch.end.y = r.changedTouches[0].pageY, 
            "fade" == f.settings.mode) ? (t = Math.abs(f.touch.start.x - f.touch.end.x), t >= f.settings.swipeThreshold && (f.touch.start.x > f.touch.end.x ? e.goToNextSlide() :e.goToPrevSlide(), 
            e.stopAuto())) :(t = 0, "horizontal" == f.settings.mode ? (t = f.touch.end.x - f.touch.start.x, 
            i = f.touch.originalPos.left) :(t = f.touch.end.y - f.touch.start.y, i = f.touch.originalPos.top), 
        ...
        return e.goToSlide = function(t, i) {
            var h, r, a, p, u, w, b;
            f.working || f.active.index == t || ((f.working = !0, f.oldIndex = f.active.index, 
            f.active.index = 0 > t ? s() - 1 :t >= s() ? 0 :t, f.settings.onSlideBefore(f.children.eq(f.active.index), f.oldIndex, f.active.index), 
            ...
            f.active.last = f.active.index >= s() - 1, f.settings.pager && v(f.active.index), 
            f.settings.controls && tt(), "fade" == f.settings.mode) ? (f.settings.adaptiveHeight && f.viewport.height() != l() && f.viewport.animate({
                height:l()
            ...
            r = u.position(), h = f.viewport.width() - u.outerWidth()) :(a = f.children.length - f.settings.minSlides, 
            ...
            u = e.children(".bx-clone").eq(p), r = u.position()) :"next" == i && 0 == f.active.index ? (r = e.find("> .bx-clone").eq(f.settings.maxSlides).position(), 
            f.active.last = !1) :t >= 0 && (w = t * c(), r = f.children.eq(w).position()), "undefined" != typeof r && (b = "horizontal" == f.settings.mode ? -(r.left - h) :-r.top, 
            ...
            }, f.settings.pause), f.settings.autoControls && 1 != n && p("stop"));
        }, e.stopAuto = function(n) {
            f.interval && (clearInterval(f.interval), f.interval = null, f.settings.autoControls && 1 != n && p("start"));
            ...
            n(this).unwrap().unwrap(), f.controls.el && f.controls.el.remove(), f.controls.next && f.controls.next.remove(), 
            f.controls.prev && f.controls.prev.remove(), f.pagerEl && f.settings.controls && f.pagerEl.remove(), 
            n(".bx-caption", this).remove(), f.controls.autoEl && f.controls.autoEl.remove(), 
            clearInterval(f.interval), f.settings.responsive && n(window).unbind("resize", ut));
    ...
    n.fn.jScrollPane = function(t) {
        function i(t, i) {
            function hi(i) {
                ...
                if (r = i, u === undefined) p = t.scrollTop(), b = t.scrollLeft(), t.css({
                    overflow:"hidden",
                    padding:0
                }), o = t.innerWidth() + g, e = t.innerHeight(), t.width(o), u = n('<div class="jspPane" />').css("padding", ei).append(t.children()), 
                f = n('<div class="jspContainer" />').css({
                    width:o + "px",
                    height:e + "px"
                }).append(u).appendTo(t); else {
                    if (t.css("width", ""), nt = r.stickToBottom && fr(), tt = r.stickToRight && er(), 
                    y = t.innerWidth() + g != o || t.outerHeight() != e, y && (o = t.innerWidth() + g, 
                    e = t.innerHeight(), f.css({
                        width:o + "px",
                        height:e + "px"
                    })), !y && vi == a && u.outerHeight() == l) return;
                    vi = a;
                ...
                r.keepTrack || v || w ? (v || w || u.css({
                    ...
                    left:0,
                    width:f.width() - g
                }), t.addClass("jspScrollable"), s = r.maintainPosition && (h || c), s && (k = ft(), 
                d = et()), di(), gi(), nr(), s && (at(tt ? a - o :k, !1), ut(nt ? l - e :d, !1)), 
                hr(), or(), pr(), r.enableKeyboardNavigation && lr(), r.clickOnTrack && ir(), vr(), 
                r.hijackInternalLinks && yr()) :(t.removeClass("jspScrollable"), u.css({
                    top:0,
                    left:0,
                    width:f.width() - g
                }), sr(), cr(), ar(), bi());
            ...
            function di() {
                ...
                r.arrowScrollOnHover && (yt.bind("mouseover.jsp", rt(0, -1, yt)), pt.bind("mouseover.jsp", rt(0, 1, pt))), 
            ...
            function gi() {
                ...
                gt = f.find(">.jspHorizontalBar"), d = gt.find(">.jspTrack"), p = d.find(">.jspDrag"), 
                ...
                r.arrowScrollOnHover && (wt.bind("mouseover.jsp", rt(-1, 0, wt)), bt.bind("mouseover.jsp", rt(1, 0, bt))), 
                wi(d, r.horizontalArrowPositions, wt, bt)), p.hover(function() {
                    p.addClass("jspHover");
                }, function() {
            ...
            function nr() {
                if (v && w) {
                    var t = d.outerHeight(), i = k.outerWidth();
                    ht -= t;
                ...
                l = u.outerHeight();
                kt = l / e;
                v && (it = Math.ceil(1 / ai * ot), it > r.horizontalDragMaxWidth ? it = r.horizontalDragMaxWidth :it < r.horizontalDragMinWidth && (it = r.horizontalDragMinWidth), 
                p.width(it + "px"), nt = ot - it, li(c));
                w && (tt = Math.ceil(1 / kt * ht), tt > r.verticalDragMaxHeight ? tt = r.verticalDragMaxHeight :tt < r.verticalDragMinHeight && (tt = r.verticalDragMinHeight), 
                y.height(tt + "px"), b = ht - tt, ci(h));
            }
            function wi(n, t, i, r) {
                ...
                w && k.bind("mousedown.jsp", function(t) {
                    if (t.originalTarget === undefined || t.originalTarget == t.currentTarget) {
                        var f = n(this), v = f.offset(), o = t.pageY - v.top - h, i, c = !0, a = function() {
                            var p = f.offset(), n = t.pageY - p.top - tt / 2, v = e * r.scrollPagePercent, y = b * v / (l - e);
                            if (o < 0) h - y > n ? s.scrollByY(-v) :st(n); else if (o > 0) h + y < n ? s.scrollByY(v) :st(n); else {
                                u();
                                return;
                            }
                ...
                v && d.bind("mousedown.jsp", function(t) {
                    if (t.originalTarget === undefined || t.originalTarget == t.currentTarget) {
                        var f = n(this), v = f.offset(), e = t.pageX - v.left - c, i, h = !0, l = function() {
                            var p = f.offset(), n = t.pageX - p.left - it / 2, v = o * r.scrollPagePercent, y = nt * v / (a - o);
                            if (e < 0) c - y > n ? s.scrollByX(-v) :lt(n); else if (e > 0) c + y < n ? s.scrollByX(v) :lt(n); else {
                                u();
                                return;
                            }
            ...
            function st(n, t) {
                w && (n < 0 ? n = 0 :n > b && (n = b), t === undefined && (t = r.animateScroll), 
                t ? s.animate(y, "top", n, ci) :(y.css("top", n), ci(n)));
            }
            function ci(n) {
                n === undefined && (n = y.position().top);
                f.scrollTop(0);
                h = n || 0;
                var i = h === 0, r = h == b, s = n / b, o = -s * (l - e);
                (ni != i || ii != r) && (ni = i, ii = r, t.trigger("jsp-arrow-change", [ ni, ii, ti, ri ]));
                rr(i, r);
                u.css("top", o);
                t.trigger("jsp-scroll-y", [ -o, i, r ]).trigger("scroll");
            }
            function lt(n, t) {
                v && (n < 0 ? n = 0 :n > nt && (n = nt), t === undefined && (t = r.animateScroll), 
                t ? s.animate(p, "left", n, li) :(p.css("left", n), li(n)));
            }
            function li(n) {
                n === undefined && (n = p.position().left);
                f.scrollTop(0);
                c = n || 0;
                var i = c === 0, r = c == nt, s = n / nt, e = -s * (a - o);
                (ti != i || ri != r) && (ti = i, ri = r, t.trigger("jsp-arrow-change", [ ni, ii, ti, ri ]));
                ur(i, r);
                u.css("left", e);
            ...
            function ui(t, i, u) {
                ...
                for (v = s.outerHeight(), y = s.outerWidth(), f.scrollTop(0), f.scrollLeft(0); !s.is(".jspPane"); ) if (h += s.position().top, 
                c += s.position().left, s = s.offsetParent(), /^body|html$/i.test(s[0].nodeName)) return;
                p = et();
                b = p + e;
            ...
            function or() {
                f.unbind(si).bind(si, function(n, t, i, u) {
                    c || (c = 0);
                    h || (h = 0);
                    var e = c, o = h, f = n.deltaFactor || r.mouseWheelSpeed;
                    return s.scrollBy(i * f, -u * f, !1), e == c && o == h;
                });
            }
            function sr() {
                f.unbind(si);
            ...
            function lr() {
                ...
                t.attr("tabindex", 0).unbind("keydown.jsp keypress.jsp").bind("keydown.jsp", function(t) {
                    if (t.target === this || o.length && n(t.target).closest(o).length) {
                        ...
                        return a = t.keyCode == i && r != c || u != h, !a;
                    }
                }).bind("keypress.jsp", function(t) {
                    if (t.keyCode == i && y(), t.target === this || o.length && n(t.target).closest(o).length) return !a;
                });
                r.hideFocus ? (t.css("outline", "none"), "hideFocus" in f[0] && t.attr("hideFocus", !0)) :(t.css("outline", ""), 
            ...
            function vr() {
                if (location.hash && location.hash.length > 1) {
                    ...
                    t.length && u.find(i) && (f.scrollTop() === 0 ? r = setInterval(function() {
                        f.scrollTop() > 0 && (ui(t, !0), n(document).scrollTop(f.position().top), clearInterval(r));
                    }, 50) :(ui(t, !0), n(document).scrollTop(f.position().top)));
                }
            }
            function yr() {
                n(document.body).data("jspHijack") || (n(document.body).data("jspHijack", !0), n(document.body).delegate("a[href*=#]", "click", function(t) {
                    ...
                    h === o) {
                        ...
                        i.length && (r = i.closest(".jspScrollable"), s = r.data("jsp"), s.scrollToElement(i, !0), 
                        r[0].scrollIntoView && (f = n(window).scrollTop(), e = i.offset().top, (e < f || e > f + n(window).height()) && r[0].scrollIntoView()), 
                        t.preventDefault());
                    }
                }));
            }
            function pr() {
                ...
                f.unbind("touchstart.jsp touchmove.jsp touchend.jsp click.jsp-touchclick").bind("touchstart.jsp", function(f) {
                    ...
                    if (r) {
                        var o = f.originalEvent.touches[0], l = c, a = h;
                        return s.scrollTo(u + t - o.pageX, e + i - o.pageY), n = n || Math.abs(t - o.pageX) > 5 || Math.abs(i - o.pageY) > 5, 
                        l == c && a == h;
                    }
            ...
            t.css("box-sizing") === "border-box" ? (ei = 0, g = 0) :(ei = t.css("paddingTop") + " " + t.css("paddingRight") + " " + t.css("paddingBottom") + " " + t.css("paddingLeft"), 
            ...
            n.extend(s, {
                ...
                scrollByX:function(n, t) {
                    var i = ft() + Math[n < 0 ? "floor" :"ceil"](n), r = i / (a - o);
                    lt(r * nt, t);
                },
                scrollByY:function(n, t) {
                    var i = et() + Math[n < 0 ? "floor" :"ceil"](n), r = i / (l - e);
                    st(r * b, t);
                },
...
var mpc = {
    ...
    updateSelObj:function(n) {
        ...
        selobj.pid == 0 && (selobj.pid = function() {
            var n = cCtrl.getLocation(), t = isIE9AndBelow ? n.url.query :n.search;
        ...
        selobj.btp2 = n.btp;
        selobj.dts = n.dts;
        o.param && (o.param.Tab = n.tab, o.param.SportId = n.spt.toString(), o.param.UIBetType = n.uibt, 
        o.param.EventDate = n.edt, o.param.IsFutureDate = n.isfd, o.param.IsInplay = n.ip, 
        o.param.IsInplayAll = n.ipo, o.param.IsFirstLoad = n.ifl);
    },
    updateUV:function(n) {
        uv && o.param && (o.param.SortBy = n.sb, o.param.OddsType = n.ov);
    },
    updateMpc:function(n) {
        mpc.pv = n.pv;
    },
    successAction:function(n, t) {
        n && (n.selobj && cCtrl.updateSelObj(n.selobj), n.uvd && (cCtrl.updateUV(n.uvd), 
        n.uvd = _.assign({}, n.uvd, t)), n.mpc && cCtrl.updateMpc(n.mpc), BS.MODE != "DEFAULT" && BS.MODE != "PLACEBET" || BS_Store.showMyBet() || BS.RemainBetSlip(!0), 
    ...
    hasOddsForToday:function(n) {
        var r, i, u, t;
        if (o.param.Tab != "Today" || selobj.cids == "") return !0;
        for (r = o.param.UIBetType, i = !1, u = 0; u < n[0].e.length; ++u) if (t = n[0].e[u], 
        r == "oe") {
    ...
    loadRefresh:function() {
        var n = cCtrl.getLocation(), t = n.pathname + n.search;
        isIE9AndBelow && (t = n.url.path + n.url.query);
        cCtrl.loadContent(t, !1, !1, null, !1);
    },
    loadContent:function(n, t, i, r, u, f) {
        var s, c, e, l, h;
        if (Action.resetTimer(), n) {
            if (s = new Date().getTime(), cCtrl.isProcessing && cCtrl.prevLoadStartTime != null && s - cCtrl.prevLoadStartTime < cCtrl.spanSec) return console.log("Subsequent requests fail to be sent while processing requests and within 2 second."), 
            !1;
            cCtrl.isProcessing = !0;
            cCtrl.prevLoadStartTime = s;
            c = !1;
            t && (e = cCtrl.getLocation(), l = e.pathname + e.search, isIE9AndBelow && (l = e.url.path + e.url.query), 
            h = n.indexOf(e.host), h > 0 && (h += e.host.length, n = n.substr(h)), l != n && (c = !0, 
            ...
            param.reqUrl = n;
            o.param && (param.oVersion = u ? null :om.versionUtil.getVersion(), param.oCompetitionId = o.param.CompetitionId, 
            param.oEventIds = o.param.EventIds, param.oIsFirstLoad = u == !0 || c == !0 ? !0 :!1, 
            param.oPageNo = o.param.PageNo, param.oSortBy = o.param.SortBy);
    ...
    changeTheme:function(n) {
        ...
        if (r.length > 0) {
            ...
            i == "black" ? (t = t.replace("/Theme_White/", "/Theme_Black/"), t = t.replace("/Theme_Blue/", "/Theme_Black/"), 
            t = t.replace("/Theme_DarkBlue/", "/Theme_Black/")) :i == "white" ? (t = t.replace("/Theme_Black/", "/Theme_White/"), 
            t = t.replace("/Theme_Blue/", "/Theme_White/"), t = t.replace("/Theme_DarkBlue/", "/Theme_White/")) :i == "blue" ? (t = t.replace("/Theme_Black/", "/Theme_Blue/"), 
            t = t.replace("/Theme_White/", "/Theme_Blue/"), t = t.replace("/Theme_DarkBlue/", "/Theme_Blue/")) :i == "darkblue" && (t = t.replace("/Theme_Black/", "/Theme_DarkBlue/"), 
            t = t.replace("/Theme_White/", "/Theme_DarkBlue/"), t = t.replace("/Theme_Blue/", "/Theme_DarkBlue/"));
            r.attr("href", t);
            selobj.themeColor = i;
        }
    },
    ...
    getQueryFromUrl:function(n) {
        var r = [], t, u, i;
        for ((typeof n != "string" || n.trim() == "") && (n = window.location.href), u = n.slice(n.indexOf("?") + 1).split("&"), 
        i = 0; i < u.length; i++) t = u[i].split("="), r.push(t[0]), r[t[0].toLowerCase()] = t[1];
        return r;
    },
    ...
    setBackCloseUrl:function(n) {
        var i = cCtrl.getLocation(), t = sessionStorage.historyUrls ? JSON.parse(sessionStorage.historyUrls) :[], r = (i.pathname + i.search).replace(location.origin, "");
        isIE9AndBelow && (r = i.url.path + i.url.query);
        (mpc.pv == 1 || mpc.pv == 0) && (sessionStorage.removeItem("historyUrls"), t = []);
        n != r && (t.length >= 100 && t.pop(), t.unshift(r), sessionStorage.historyUrls = JSON.stringify(t));
    },
    goBackClosePage:function() {
        var t = sessionStorage.historyUrls ? JSON.parse(sessionStorage.historyUrls) :[ "/" + global.lan + "/sports" ], n = t.shift();
    ...
    goPageNotFound:function() {
        if (cCtrl.isProcessing = !1, parent.location.href) parent.location.replace(parent.location.origin + "/" + global.lan + "/page-not-found"); else {
...
var CONSTANTS = {
    ...
    INPLAY:1,
    STARTINGSOON:2
}, Router = ReactModule.createModule("Router", { //链接
    home:function() {
    ...
    lpSport:function(n, t) {
        var i = Router.props.header, r = n.sid;
        switch (t) {
          default:
          case VIEW.PRESTART:
            i += n.sen;
    ...
    competition:function(n, t, i) {
        ...
        return r += i ? "/mycompetition" :"/competition", r + ("/full-time-asian-handicap-and-over-under?competitionids=" + t);
    },
    ...
    selectedCompetitionMenu:function(n) {
        var r, t, i;
        if (o.param.IsInplay) r = "inplay"; else if (selobj.dts) for (t = 0; t < selobj.dts.length; ++t) selobj.dts[t].IsSelect && (r = selobj.dts[t].Date);
        return i = this.competitionMenu(n, !1), selobj.cids != "" && (i = i + "?competitionids=" + selobj.cids), 
        i;
    },
    event:function() {
        var i = Router.props.header + arguments[0], n, t = "";
        arguments.length == 3 ? (n = arguments[1], t = arguments[2]) :arguments.length == 2 && (_.isString(arguments[1]) ? t = arguments[1] :n = arguments[1]);
    ...
    outright:function(n, t) {
        ...
        return t != null && (i += "?competitionids=" + t), Router.props.header + n + i;
    },
    betType:function(n) {
        var f = cCtrl.getLocation(), e = f.pathname, s = f.search, i;
        isIE9AndBelow && (e = f.url.path, s = f.url.query);
        var t = e.split("/"), r = s.replace(/pageno=\d*/i, "pageno=1"), u = "";
        if (t.length == 4) u = o.param.SportId == 1 ? t.join("/") + "/matches-by-date/" + o.param.Tab + "/" + n + r :t.join("/") + "/competition/" + n + r; else if (t.length == 5) u = t.join("/") + "/" + (selobj.pid > 0 ? "competition/" :"") + n + r; else if (t.length == 6) {
            for (i = 0; i < o.stateObjs.bts.length; i++) if (t[5] == o.stateObjs.bts[i].k) {
                t.splice(5, 1);
                break;
            }
            ...
            for (i = 0; i < o.stateObjs.bts.length; i++) if (t[6] == o.stateObjs.bts[i].k) {
                t.splice(6, 1);
                break;
            }
...
Router.createStore("Router", {
    ...
    init:function() {
        var t = this.props.cookie, n = this.state;
...
var Action = function() {
    ...
    createNew:function() {
        ...
        function t() {
            ...
            if (i != null && i != "") for (r = i.split("&"), t = 0; t < r.length; t++) {
                n = r[t].split("=");
                switch (n[0]) {
                  case "isLock":
        ...
        function f() {
            ...
            if (r && r != "") {
                for (n = {}, u = r.split("&"), i = 0; i < u.length; i++) {
                    t = u[i].split("=");
                    switch (t[0]) {
                      case "eventId":
        ...
        function o() {
            ...
            if (r && r != "") {
                for (u = r.split("&"), n = {}, i = 0; i < u.length; i++) {
                    t = u[i].split("=");
                    switch (t[0]) {
                      case "eventId":
                        n.playingEventId = t[1];
        ...
        function s(n, t, i, r, u, f, e, o) {
            var s = "eventId=" + n + "&lsId=" + f + "&aTeamName=" + i + "&hTeamName=" + t + "&sportId=" + r + "&lang=" + u + "&vidoProvider=" + e, h = o ? ccparam.CONTENT_CONSOLE_DEFAULT_PLAY_MOREBET_COOKIE_NAME :ccparam.CONTENT_CONSOLE_CURRENT_PLAY_MOREBET_COOKIE_NAME;
        ...
        function h(n) {
            ...
            if (u && u != "") {
                for (f = u.split("&"), t = {}, r = 0; r < f.length; r++) {
                    i = f[r].split("=");
                    switch (i[0]) {
                      case "eventId":
...
}.createNew(), liveCentreControl = {
    createNew:function() {
        function s(n) {
            n == "km-kh" && (n = "en-gb");
            var t = n.split("-"), i = "";
            return t.length > 1 ? (t[1] === "zh-cn" && (t[1] = "zh-ch"), i = t[0] + "-" + t[1].toUpperCase()) :i = n, 
            i;
        }
        function h() {
            ccparam.isEnlarge = !0;
            var n = document.getElementById(ccparam.targetId);
            n && (n.width = ccparam ? ccparam.width_enlarge :418, n.height = ccparam ? ccparam.height_enlarge :346, 
            utility.cookie.write(ccparam.CONTENT_CONSOLE_ENLARGE_STATUS, "true", ccparam.expireDays));
        }
        function c() {
            ccparam.isEnlarge = !1;
            var n = document.getElementById(ccparam.targetId);
            n && (n.width = ccparam ? ccparam.width :240, n.height = ccparam ? ccparam.height :245, 
        ...
        function a(r) {
            ...
            uv.login ? utility.service("LiveTv", "GetEventDetailsWithoutChkRegion", {
                ...
                if (p.length > 0 && (y = p[0].getAttribute("cc-info"), y && y != "")) {
                    var s = y.split("|"), e = s[0], h = s[1], c = s[2], l = s[3], a = f && f.stv ? s[4] :"", v = s[5], w = cookies.getDefaultTvInfo();
        ...
        function v(i, r, u, f, e, o, s) {
            try {
                ...
                if (ccparam.playingEventId == i && ccparam.playingLsId == e) return;
                om.isPlayingCC ? (ccparam.playingEventId = i, ccparam.playingLsId = e, ccparam.hTeamName = r, 
                ccparam.aTeamName = u, ccparam.sportId = f, ccparam.currentDelayTimesToPlayNextEvent = 0, 
        ...
        function p() {
            ccparam.checkEventTimer && (clearInterval(ccparam.checkEventTimer), ccparam.checkEventTimer = null);
            ccparam.checkEventTimer = setInterval(function() {
                utility.service("LiveTv", "CheckPlayingBGEvent", {
                    ...
                    typeof n.cdbg != "undefined" && n.cdbg != uv.cdbg && (uv.cdbg = n.cdbg, ccparam.playingEventId = "", 
                    ccparam.playingLsId = "", om.isPlayingCC = !1, om.isFoundBg = !1, uv.cdbg ? mpc.pv == 2 ? omb.playCC(!0) :mpc.pv == 1 && n.ipe && om.playCC() :liveCentreControl.clearDefaultBgInfo());
                    ...
                    ccparam.playingEventId = "", om.isFoundBg = !1, om.isPlayingCC = !1, uv.cdbg && mpc.pv == 1 && (ccparam.previousPlayingEventId == lockInfo.eventId && lockInfo.isLock && Action.RightPanel.TV.toggleLockBtn(!1, !0), 
                    w())));
                });
        ...
        function w() {
            ...
            if (liveCentreControl.clearDefaultBgInfo(), uv.login && ccparam.playingLsId != "" ? (ccparam.previousPlayingEventId != "" && o.$mainOddsPanel.find("#e" + ccparam.previousPlayingEventId + " .btn-tv-ip").removeClass("bgs"), 
            ...
            t = o.$mainOddsPanel.find(".btn-livematch-ip:not(.hidden)"), s = !1, t.length > 0) {
                for (i = 0; i < t.length; i++) if (r = t[i], r && (f = r.getAttribute("cc-info"), 
                f && f != "")) if (n = f.split("|"), u = n[0], h = n[1], c = n[2], e = n[3], l = n[4], 
                a = n[5], ccparam.previousPlayingEventId != u) {
                    s = !0;
                    break;
                } else r.className += " hidden", i === t.length - 1 && (ccparam.previousPlayingEventId = "");
            } else ccparam.previousPlayingEventId = "";
            s && (liveCentreControl.saveDefaultBgInfo(u, h, c, e, global.lan, l, a), om.isFoundBg = !0, 
        ...
        var u = function() {
            ...
            lockInfo.isLock && (Action.RightPanel.TV.toggleLockBtn(!0, !1), r(lockInfo.eventId, lockInfo.hTeamName, lockInfo.aTeamName, lockInfo.sportId, lockInfo.lsId, lockInfo.videoProvider, uv.login));
            ...
            var h = ccparam.width, c = ccparam.height;
            try {
                if (t(), lockInfo.isLock && (n = lockInfo.eventId, e = lockInfo.lsId, i = lockInfo.hTeamName, 
                r = lockInfo.aTeamName, u = lockInfo.sportId, o = lockInfo.videoProvider), ccparam.playingEventId = n, 
                ccparam.playingLsId = e, ccparam.hTeamName = i, ccparam.aTeamName = r, ccparam.sportId = u, 
                ccparam.videoProvider = o, ccparam.currentDelayTimesToPlayNextEvent = 0, !scorecentre) return;
                utility.service("LiveTv", "GetLiveStramProvider", {
                    ...
                    var i = t.pvdr == "s" && e != "" ? t.strmId :e, r = pm.parentHost(), o = r == null ? document.location.origin :r;
                    liveCentreControl.getEnlargeStatus() && (h = ccparam.width_enlarge, c = ccparam.height_enlarge);
            ...
            try {
                if (t(), typeof scorecentre == "undefined" || !scorecentre) return;
                om.isPlayingCC ? (ccparam.playingEventId = i, ccparam.playingLsId = e, ccparam.hTeamName = r, 
                ccparam.aTeamName = u, ccparam.sportId = f, ccparam.videoProvider = o, ccparam.currentDelayTimesToPlayNextEvent = 0, 
        ...
        }, b = function() {}, k = function() {}, d = function() {}, g = function() {};
        return {
            Init:u,
            showErrorMsg:f,
            hideErrorMsg:t,
...
}.createNew(), UI = ReactModule.createModule("ui", {}, function() {
...
UI.createStore("ui", {
    init:function() {
        ...
        this.state.browser = navigator.sayswho = function() {
            ...
            return /trident/i.test(n[1]) ? (t = /\brv[ :]+(\d+)/g.exec(i) || [], "IE " + (t[1] || "")) :n[1] === "Chrome" && (t = i.match(/\b(OPR|Edge)\/(\d+)/), 
    ...
    methods:{
        update:function() {
            ...
            switch (this.state.indicator) {
              ...
              case this.props.INDICATOR.CENTER:
                switch (this.state.view) {
                  ...
                  case UIVIEW.R1280:
                    this.state.pv == 2 ? (this.state.left.minimized = !1, this.state.right.isLarge = !0) :this.state.pv == 1 && (this.state.left.minimized = this.state.center.is1stHalfOn || this.state.center.isBasketball ? this.state.isInplay && n ? !0 :!1 :!1);
                    break;
              ...
              default:
                switch (this.state.view) {
                  case UIVIEW.R1024:
                    ...
                    this.state.right.isLarge = n) :(this.state.left.minimized = !1, this.state.right.isLarge = !1) :this.state.center.is1stHalfOn ? (this.state.left.minimized = !0, 
                    this.state.right.isLarge = !1) :(this.state.left.minimized = n ? !0 :!1, this.state.right.isLarge = n);
                    break;

                  case UIVIEW.R1280:
                    this.state.pv == 2 ? (this.state.left.minimized = !1, this.state.right.isLarge = !0) :this.state.center.is1stHalfOn || this.state.center.isBasketball || n ? (this.state.left.minimized = (this.state.center.is1stHalfOn || this.state.center.isBasketball) && n ? !0 :!1, 
                    this.state.right.isLarge = n) :(this.state.left.minimized = !1, this.state.right.isLarge = !1);
                    break;
            ...
            this.state.pv == 0 ? (this.state.left.minimized = !1, this.state.right.isLarge = !1) :this.state.pv == 1 ? (o.param.UIBetType != "ftahou" && o.param.UIBetType != "ft1x2" && (this.state.left.minimized = !1), 
        ...
        updateSize:function() {
            ...
            var n = this.getView(), t = n != this.state.view;
            t && (this.state.view = n, this.state.indicator = this.props.INDICATOR.WINDOW, this.update(), 
            this.updateBodyCss(), this.dispatch());
        },
        getView:function() {
            var n;
        ...
        hasBasketball:function(n) {
            if (_.isArray(n)) for (var t = 0; t < n.length; t++) if (n[t].k == 2) return !0;
            return !1;
        },
        dispatch:function() {
        ...
        SITEREFRESH:function(n) {
            o.param.IsFirstLoad && (this.state.center.is1stHalfOn = null, this.state.center.isBasketball = this.hasBasketball(_.isUndefined(n.mod) ? null :n.mod.d), 
            this.state.pv = n.mpc.pv, this.state.isInplay = n.selobj.ip, this.state.uiBetType = o.param.UIBetType, 
    ...
    "public":{
        LEFTPANEL_COLLAPSE:function(n) {
            ...
            t && (this.state.left.minimized = n, this.state.indicator = this.props.INDICATOR.LEFT, 
            this.update(), this.dispatch());
        },
        RPRESIZE:function(n) {
            var t = this.state.right.isLarge != n;
            t && (this.state.right.isLarge = n, this.state.indicator = this.props.INDICATOR.RIGHT, 
            this.update(), this.dispatch());
        },
        MPRESIZE:function(n) {
            var t = this.state.center.is1stHalfOn != n;
            t && (this.state.center.is1stHalfOn = n, this.state.indicator = this.props.INDICATOR.CENTER, 
            this.update(), this.dispatch());
        }
    }
});
...
Timer.createSingularStore({
    ...
    props:{
        timer:function() {
            function o(n, t, i) {
                ...
                this.Work = i;
                this.step = function() {
                    f && (u -= r, u <= 0 && (u = this.interval, this.Work()));
                };
                this.start = function() {
                    f || (u = this.interval, f = !0);
                };
                this.stop = function() {
                    f = !1;
                };
            ...
            function i(t) {
                for (var i = 0; i < n.length; i++) if (n[i].id == t) return {
                    i:i,
                    item:n[i]
                };
            }
            function f(f, e) {
                var s, o;
                if (f) s = i(f), s && s.item.toggle(e); else for (o = 0; o < n.length; o++) n[o].toggle(e);
                e && !t && (t = !0, u = window.setInterval(function() {
                     for (o = 0; o < n.length; o++) n[o].step();
                }, r));
            }
            ...
            return {
                add:function() {
                    var t, r, u, f, s;
                    if (arguments.length == 3) t = arguments[0], r = arguments[1], u = arguments[2]; else if (arguments.length == 2) t = e++, 
                    r = arguments[0], u = arguments[1]; else return;
                    return f = new o(t, r, u), s = i(t), s ? n[s.i] = f :n.push(f), t;
                },
                remove:function(t) {
                    var r = i(t);
                    r && n.splice(r.i, 1);
                ...
                getJobs:function() {
                    for (var i = [], t = 0; t < n.length; t++) i.push(n[t].getDesc());
                    return i;
                },
                start:function(n) {
                    f(n, !0);
    ...
    "public":{
        after:function(n, t) {
            ...
            return this.state.schedule[i] || (this.state.schedule[i] = []), r = {
                c:t
            }, this.state.schedule[i].push(r), function() {
                r.c = function(n) {
        ...
        interval:function(n, t) {
            //console.log(".....")
            var r = this, i = this.props.timer.add(n * 1e3, function() {
                t(r.state.tick);
            });
            return this.props.timer.start(i), i;
        },
        remove:function(n) {
...
var ScrollerBar = function() {
    function h() {
        UI.isIE || (t.hasClass("jspScrollable") ? i.reinitialise() :(t.jScrollPane({
            ...
            horizontalGutter:0,
            keepTrack:!0
        }), i = t.data("jsp"), $(window).bind("resize", i.reinitialise)), e = !0);
    }
    function c() {
        u = $("#quickMenu");
        ...
        f = $("#quickMenuOptions");
        s();
        n.hasClass("jspScrollable") ? (r.reinitialise(), r.scrollTo(0, 0)) :(n.jScrollPane({
            showArrows:!1,
            hideFocus:!0,
            verticalGutter:0,
            horizontalGutter:0,
            keepTrack:!1
        }), r = n.data("jsp"), $(window).bind("resize", function() {
            u.hasClass("collapsed") || (s(), r.reinitialise());
        }));
    }
    function l() {
        if (UI.isIE) t[0].scrollTop = 0; else if (e) i.scrollTo(0, 0); else throw new Error("Scroll Bar Has Not Been Initialized. Pls Call initScrollbarStatus() Before Using This Function.");
    }
    function s() {
...
BS.bsCookie = {
    ...
    getCookieValue:function(n) {
        ...
        if (BS.bsCookiesValues.length == 12) switch (n) {
          case "BetSlip@strSelList":
...
BS.Utility = {
    Replace:function(n) {
        return n == "" ? 0 :(typeof n != "string" && (n = "" + n), n = n.replace(/[^a-zA-Z 0-9.]+/g, ""), 
        parseFloat(n));
    },
...
BS.PopulateParams = function(n, t, i) {
    ...
    try {
        if (n.s[0] != null) if (t || n.k == !0 && (n.s = $.grep(n.s, function(n) {
            return n.rsl != 9999 && n.rsl != 8888;
        })), i) for (u = 0; u < n.s.length; u++) {
            var r = n.s[u], f = r.st, e = !isNaN(f) && f > 0 ? f :0;
        ...
        } else for (u = 0; u < n.s.length; u++) r = n.s[u], BS.strSelList += r.sid + BS.SEPARATOR, 
        BS.strEventList += r.eid + BS.SEPARATOR, BS.strOddsList += r.o + BS.SEPARATOR, BS.strHdpList += r.hd + BS.SEPARATOR, 
        BS.strScoreList += r.hs + ":" + r.as + BS.SEPARATOR, BS.strAmtList += r.st + BS.SEPARATOR, 
        BS.strInplayList += r.ip + BS.SEPARATOR, BS.strParlayList += r.ap + BS.SEPARATOR, 
        BS.strClosedList += r.rsl + BS.SEPARATOR, BS.strParentEventList += r.peid + BS.SEPARATOR;
    } catch (o) {
        console.log(o);
    }
...
BS.PopulateComboData = function(n, t) {
    ...
    if (n.cinfo[0] != null && (n.c = [], s != null && s != "")) for (u = s.split(BS.SEPARATOR), 
    n.cno = u.length, i = BS.bsCookie.getCookieValue(BS.cbStakeCookies), i != null && (i = i.split(BS.SEPARATOR), 
    i.length != u.length && (i = null)), f = 0; f < u.length; f++) if (e = u[f].split("@"), 
    u.length > 0) for (o = 0; o < n.cinfo.length; o++) if (r = n.cinfo[o], r.wid == e[0]) {
        n.c[f] = {
            wid:parseFloat(e[0]),
            bc:parseFloat(e[1]),
...
BS.GenerateComboBet = function(n) {
    var f = 0, i = 0, r = "", u, t;
    if (BS.strEventList = BS.bsCookie.getCookieValue(BS.eventListCookies), BS.strEventList == null) return null;
    if (u = BS.strEventList.split(BS.SEPARATOR), i = u.length, u.length > 1 && i > 1 && (r += "1@" + i), 
    n > 0) {
        for (t = 1; t <= n; t++) f += BS.Utility.Combination(n, t), t > 1 && (r += BS.SEPARATOR + t + "@" + BS.Utility.Combination(n, t));
...
BS.CountCombination = function(n, t, i, r, u, f) {
    ...
    if (n.iscom = !0, h.length == 1) return 0;
    for (e = 0, y = h.length; e < y; e++) {
        if (p[e] == "true" || w[e] == "false" || b[e] == "8888") {
            n.iscom = !1;
            continue;
        }
        for (s = 0; s < o.length; s++) (o[s] == h[e] || o[s] == c[e]) && (l[k++] = c[e], 
        n.iscom = !1);
        o[o.length] = c[e];
        a = l.unique().length;
        v = o.unique().length;
    }
    return n.canNotParlay = l.unique(), v - a;
};

BS.verifyEventId = function(n, t) {
    var i = BS.getBetSlipdata(), r, u;
    if (i.s[0] != null) {
        for (r = 0; r < i.s.length; r++) if (u = i.s[r], u.sid == n && u.eid == t) return "UPDATE";
...
BS.AddSelection = function(n, t, i, r, u, f, e) {
    ...
    BS.MODE = "PLACEBET"), o = BS.verifyEventId(n, t), /UPDATE/i.test(o) ? BS.RemoveSelection(n) :/ADD/i.test(o) ? (c = !1, 
    BS.MODE = "PROCESSING", s = BS.getBetSlipdata(), BS.PopulateParams(s, !1, !0), s.s[0] != null ? (BS.strSelList = n + BS.SEPARATOR + BS.strSelList, 
    BS.strEventList = t + BS.SEPARATOR + BS.strEventList, BS.strOddsList = i + BS.SEPARATOR + BS.strOddsList, 
    BS.strHdpList = r + BS.SEPARATOR + BS.strHdpList, BS.strScoreList = u + BS.SEPARATOR + BS.strScoreList, 
    BS.strAmtList = "0" + BS.SEPARATOR + BS.strAmtList, BS.strInplayList = f + BS.SEPARATOR + BS.strInplayList, 
    BS.strParentEventList = e + BS.SEPARATOR + BS.strParentEventList) :(c = !0, BS.strSelList += n, 
    BS.strEventList += t, BS.strOddsList += i, BS.strHdpList += r, BS.strScoreList += u, 
    BS.strAmtList += "0", BS.strInplayList += f, BS.strParentEventList += e), utility.service(BS.service.betSlipService, BS.service.getSelectionService, {
    ...
    })) :(h = BS.strSelList.split(BS.SEPARATOR), _.includes(h, n) || BS.fire(BS.Events.RemoveHighlightOdds, [ [ "" + n ] ]), 
    BS.fire(BS.Events.ExceedMaxiumSelections)));
};

BS.RemoveSelection = function(n) {
    if (BS.MODE != "PROCESSING" && BS.MODE != "PROCESSED") {
        var t = BS.getBetSlipdata(), i = t.s;
        t.s = jQuery.grep(t.s, function(t) {
            return t.sid != n;
        });
        t.s[0] != null ? (BS.fire(BS.Events.Processing), BS.PopulateParams(t, !1, !0), utility.service(BS.service.betSlipService, BS.service.getSelectionService, {
            SelList:BS.strSelList,
            EventList:BS.strEventList,
            OddsList:BS.strOddsList,
            HdpList:BS.strHdpList,
...
BS.VerifyBetSlip = function(n) {
    var t;
    if (n.islog == !1) return !1;
    var u = !0, s = !0, f = 0;
    for (t = 0; t < n.s.length; t++) {
        var i = n.s[t], r = i.st, c = i.o, e = i.bs.bmin;
        i.serr = null;
        c == 0 && (i.serr = "BS_OddsUpdating", f++);
        BS.Utility.Replace(r) != "" && BS.Utility.Replace(r) < e && (i.serr = "BS_NotExceedMinBet", 
        i.errMsg = l.BS_Minimum_Bet + " " + BS.Utility.AddCommas(e) + " " + n.cc, i.st = e, 
        u = !1);
    }
    if (n.totalStake <= 0 && f < n.s.length) return n.info = l.BS_Stake_Amount, !1;
    if (f == n.s.length.length) return !1;
    for (t = 0; t < n.c.length; t++) {
        var o = n.c[t], r = o.cba, h = o.cbs.bmin;
        BS.Utility.Replace(r) != "" && BS.Utility.Replace(r) < h && (o.cba = h, s = !1);
    }
    return !u || !s ? (u || n.c[0] == null || (n.c[0].cba = ""), !1) :(n.info = null, 
    !0);
};
...
BS.ProcessBet = function(n) {
    ...
    if (BS.processing = !0, BS.fire(BS.Events.Processing), BS.bsCookie.clearBSCookies(), 
    u = "", n.c[0] != null) {
        for (e = 0; e < n.c.length; e++) r = n.c[e], t = BS.Utility.Replace(r.cba), (isNaN(t) || t <= 0) && (t = 0), 
        s = r.co == null ? "" :r.co, h = parseFloat(t * s - t * r.bc), u += r.cbn + "@" + r.bc + "@" + t + "@" + h + "@" + r.wid + BS.SEPARATOR;
        u = u.slice(0, -1);
    }
    for (f = "", o = 0; o < n.s.length; o++) (i = n.s[o], t = BS.Utility.Replace(i.st), 
    ...
    utility.service(BS.service.betSlipService, BS.service.placeBetService, {
        ...
        BS.PopulateComboData(n), BS.UpdateBetSlip(n, !1, !0)) :(t = n.s.map(function(n) {
            return n.sid + "";
        }), BS.fire(BS.Events.RemoveHighlightOdds, [ t ]), BS.UpdateSummary(n), BS.fire(BS.Events.RefreshBalance));
    }, function() {
        BS.MODE = "DEFAULT";
        BS.processing = !1;
...
BS.UpdateBetSlip = function(n, t, i) {
    ...
    n.s[0] != null ? (BS.MODE = "PLACEBET", BS.StarAutoRefresh()) :(BS.MODE = "DEFAULT", 
    BS.StopAutoRefresh());
...
BS.RemainBetSlip = function(n) {
    if (BS.strSelList = BS.bsCookie.getCookieValue(BS.selListCookies), BS.strSelList != null && BS.strSelList != "") try {
...
BS.ModifyDisplayInformation = function(n) {
    var r, t, u, i;
    if (n.s[0] != null) for (r = 0; r < n.s.length; r++) t = n.s[r], t.serr == "BS_DailyBetLimitValue" && (l.BS_DailyBetLimitValue = l.BS_DailyBetLimit.replace("XXX", BS.Utility.AddCommas(t.cv) + " " + n.cc)), 
    ...
    t.bn == "BS_FLScorer" && (t.bn = l.BS_FLScorer), t.bn == "BS_FLTeamTS" && (t.bn = l.BS_FLTeamTS);
    if (n.c[0] != null) for (u = 0; u < n.c.length; u++) i = n.c[u], i.cerr == "BS_DailyBetLimitValue" && (l.BS_DailyBetLimitValue = l.BS_DailyBetLimit.replace("XXX", BS.Utility.AddCommas(i.cv) + " " + n.cc)), 
...
BS.WriteOddsHDPScoreCookies = function(n) {
    var i = "", r = "", u = "", f, t;
    if (n.s[0] != null) {
        for (f = 0; f < n.s.length; f++) t = n.s[f], i += t.o + BS.SEPARATOR, r += t.hd + BS.SEPARATOR, 
...
//打印返回下注的单号
BS.BetReceiptToPrint = function(){
    var n = BS.getBetSlipdata();
    return n;
}

BS.GetSelectionIds = function() {
    var n = [], t = BS.bsCookie.getCookieValue(BS.selListCookies);
    return t != null && (n = t.split(BS.SEPARATOR)), n;
};
...
opSetting = {
    CanDisplayScore:function(n) {
        ...
        for (i = 0; i < t.length; i++) if (t[i] == n) return !0;
        return !1;
    },
    IsOutRightSport:function(n) {
        var t = opORSports.split(",");
        for (i = 0; i < t.length; i++) if (opORSports[i] == n) return !0;
        return !1;
    },
        ...
        var s = function() {
            ...
            switch (r.type) {
              case CONSTANTS.SITEREFRESH:
                ...
                t.l.m.isNetSports = _.includes(e, t.l.m.sid)), _.forEach(t.l.s, function(n) {
                    n.cds = n.ip ? opSetting.CanDisplayScore(n.sid) :!1;
                    n.isNetSports = _.includes(e, n.sid);
                }), t.r = _.cloneDeep(t.l.s), l(), 
                Timer.interval(1, function() {
                    n.needScrollTop = !f;
                    n.isFirstLoad = !1;
                }), 
                t.l.hnps.length == 0 && (n.isDisplayHL = !0), n.isFirstLoad = param.IsFirstLoad) :(f = !1, 
                n.isDisplayHL = !0, t.l.r = null, n.elapsed = null);
                i();
                break;
            ...
            n.isDisplay && (n.odds.isEuroOdds = uv.ov === 1, n.oddsType = uv.ov, n.bannerURL = s());
        }, l = function() {
            var f, u, e, o, n, i;
            r = null;
            f = [ "hip", "hnph", "hnps" ];
            for (n in t.l) if (f.indexOf(n) !== -1 && t.l[n] instanceof Array) for (i = 0; i < t.l[n].length; i++) u = t.l[n][i], 
            e = u.k, o = u.v, r || (r = {}), r[e] = o;
        };
        return {
            getData:function() {
                return t;
...
LPM = ReactModule.createModule("LeftPanel", {
    filter:function() {
        for (var t = arguments[0], i, n = 1; n < arguments.length; n++) i = arguments[n], 
        t = _.isFunction(i) ? _.filter(t, i) :_.flatten(_.pluck(t, arguments[n]));
        return t;
    },
    getIdListFromCookie:function(n, t) {
        var i = utility.cookie.read(n);
        return i ? (i = i.split(t), i.length > 0 && (i = _.compact(_.map(i, _.parseInt)))) :i = [], 
        i;
    },
    ...
    trimSportName:function(n) {
        ...
        return i.n = n.length > t ? n.substr(0, t) + "..." :n, i.t = n.length > t, i;
    },
    trimTeamName:function(n, t) {
        ...
        return r.n = n.length > i ? n.substr(0, i) + "..." :n, r.t = n.length > i, r;
    },
    ...
    trimSingleProgrammeName:function(n) {
        ...
        return i.n = n.length > t ? n.substr(0, t) + "..." :n, i.t = n.length > t ? !0 :!1, 
        i;
    },
    ...
    inplayTimeCheck:function(n) {
        ...
        return t.puc = _.filter(n, function(n) {
            return n.ces = _.filter(n.ces, function(n) {
                var t = +n.ipt.split(":")[0];
                return t <= global.thi;
            }), t.count += n.ces.length, n.ces.length > 0;
        }), t;
    }
}, function() {
    Object.defineProperty(this, "view", {
...
LPM.createMixin("expandMixin", {
    expand:function(n) {
        n.stopPropagation();
        var t = 400, i = $(this.refs.expandObj.getDOMNode()).stop(!0, !0), r = function() {
...
LPM.createMixin("sExpandHandler", {
    setActives:function(n) {
        var t, i;
        LPM.firstLoad && (t = this.getSelectedSequence(), t.length > 0 && (this.state.actives = n ? t :_.union(this.state.actives, t)), 
        i = this.getExpandList(this.props.dataKey), this.state.cActives = t, this.state.actives = _.union(this.state.actives, i), 
    ...
    getSelectedSequence:function() {
        ...
        }), t.length > 0 && (i = [ "s" + n[0].sid, "c" + t[0].cid ])), i;
    },
    getExpandList:function(n) {
        var e = [], r, f, u;
        this.state.viewAll = {};
        var s = 0, c = this.props.limit, h = this.state[n];
        for (r = 0; r < h.length; r++) {
            if (s >= c) break;
            var t = this.props.expandConfig[r] || _.last(this.props.expandConfig), i = h[r], o = 0;
            for (f = 0; f < i.puc.length; f++) {
                if (u = i.puc[f], o >= t[0]) break;
    ...
    LEFTPANEL_EXPAND:function(n) {
        ...
        n != "s" + this.state.s))) if (this.props.view != VIEW.PRESTART && LPM.collapsed && _.startsWith(n, "s")) {
            var t = _.contains(this.state.cActives, n);
            this.state.cActives = t ? [] :[ n ];
        } else this.state.actives = _.xor(this.state.actives, [ n ]), this.state.cActives && (this.state.cActives = _.xor(this.state.cActives, [ n ]));
    },
...
LPM.createStore("LeftPanel", {
    ...
    methods:{
        updateData:function(n) {
            ...
            this.state.firstLoad && (tempStore.set("needScrollToAnchor", !0), this.state.menuState = -1);
        ...
        _handleInplayFootball:function(n) {
            ...
            t && t.puc.length > 0 && (i = LPM.inplayTimeCheck(t.puc), this.state.ipFB = _.assign({}, t), 
            this.state.ipFB.puc = i.puc, this.state.ipFB.ipc = i.count, this.state.tipc += i.count - t.ipc);
        }
    }
});
...
LPM.createStore("PreStart", {
    ...
    init:function(n) {
        ...
        n.showRacing && (this.state.gap = 5 + n.otherSports.length, i = Router.racing(), 
    ...
    methods:{
        LEFTPANEL_MY_COMPETITION_TOGGLE:function(n) {
            ...
            this.state.mycomps.favt == 2 && this.state.c === n.cid && tempStore.set("redirect", _.where(this.state.smd, {
                sid:this.state.s
            })[0])) :(this.state.mycomps.data = _.union(t, this.state.mycomps.data), this.state.mycomps.info.push(n), 
        ...
        LEFTPANEL_MY_COMPETITION_ORDER:function(n) {
            ...
            i == 0 && r == -1 || i + r == t.length || (u = t[i], t[i] = t[i + r], t[i + r] = u);
        ...
        LEFTPANEL_MY_COMPETITION_EXPAND:function(n) {
            if (this.state.mycomps.data.length == 0) return !1;
            this.state.mycomps.collapsed = n;
        },
        updateData:function(n) {
            var t, i;
            n.lpd && (t = n.lpd.sm, this.state = _.extend(this.state, {
                ...
                redirect:!1
            }), this.props.showRacing && (otherSports = this.props.otherSports, this.state.topSports = otherSports), 
            LPM.view == this.props.view && (this.leftpanel_reset(), this.state.s = n.selobj.spt, 
            this.state.c = parseInt(n.selobj.cids), n.lpc.smv == 2 ? (this.state = _.extend(this.state, {
                e:n.selobj.evt
            }), this.state.events.length > 0 && (i = this.state.events[0].ces, i.length > this.state.eventMenuSize && (_.contains(_.pluck(_.take(i, this.state.eventMenuSize), "eid"), this.state.e) || (this.state.viewAll = !0))), 
            this.state.mycomps.favt = 1) :n.selobj.favT == 2 ? (this.state.mycomps = _.extend(this.state.mycomps, {
                favt:n.selobj.favT,
                active:+n.selobj.cids
            }), this.state.submenuView = 1, this.checkMyCompsNeedViewAll(n.selobj)) :(this.state = _.extend(this.state, {
                p:n.selobj.pid
...
LPM.createStore("InPlay", {
    ...
    methods:{
        updateData:function(n) {
            if (n.lpd) {
                ...
                this.state.eventViewFirsload = !0), this.state = _.extend(this.state, {
                    e:n.selobj.evt,
                    s:n.selobj.spt
                }), this.setActives(), this.state.myeventInfo = this.getMyEvents()) :(this.LEFTPANEL_RESET(), 
                this.state = _.extend(this.state, {
                    e:!1,
                    s:n.selobj.spt
        ...
        getMyEvents:function() {
            var i = this.state.ismd, t = this.state.myevents, n = [];
    ...
    "public":{
        filter:function() {
            if (this.state.myevents.length == 0) return this.state.ismd;
            var t = this.state.myevents, n = _.clone(this.state.ismd, !0);
    ...
    methods:{
        updateData:function(n) {
            if (n.lpd) {
                ...
                this.state.eventViewFirsload = !0), this.state.isRefresh = !0, this.state = _.extend(this.state, {
                    e:n.selobj.evt,
                    s:n.selobj.spt
...
var tempStore = function() {
    ...
    function t(n) {
        var r, u, i, t;
        try {
            if (n && n.p && !o.param.IsInplay && (o.param.PageNo = n.p.c == -1 ? 0 :n.p.c, o.totalPages = n.p.t), 
            o.param.IsFirstLoad) if (n && !n.error) if (n.d) {
                if (n.d instanceof Array) {
                    for (t = 0; t < n.d.length; t++) if (n.d[t].c) {
                        r = n.d[t].c;
                        break;
                    }
                } else r = n.d.c;
                if (r && r.length > 0 && cCtrl.hasOddsForToday(r)) om.processData.loadAsync(n); else if (n.bt && n.bt.length > 0) {
                    for (u = !1, i = param.reqUrl, t = 0; t < n.bt.length; t++) if (n.bt[t].sk == o.param.UIBetType || o.param.Tab == "Today" && n.bt[t].sk == "or") {
                ...
                cCtrl.isProcessing = !1;
                om.processData.loadAsync(n);
            }, cCtrl.spanSec); else n.error && cCtrl.goPageNotFound(); else om.processData.refreshAsync(n);
        } catch (f) {
    ...
    var n = -1, i = dispatcher.register(function(i) {
        switch (i.type) {
          case CONSTANTS.SITEREFRESH:
            mpc.pv == 1 ? t(i.data.mod) :(om.timerUtil.clearTimer(), o.$loading.addClass("hidden"));
            n != mpc.pv && (o.$mainOddsPanel[mpc.pv == 1 ? "removeClass" :"addClass"]("hidden"), 
            Action.PopUp.hide(), n = mpc.pv);
            break;
...
var oddsPage = {
    ...
    setSelectedAllCompetitions:function(n, t) {
        if (t) {
            if (t.indexOf("select-competition") != -1 || t.indexOf("morebet") != -1) return;
            var i = t.split("/");
            if (i.length == 4 && !isNaN(i[3])) return;
        }
    ...
    getStartSoonMins:function(n, t, i) {
        var u = LPM.getSSMin(n, t, i), r = l.LP_StartingInMins.replace("{0}", u);
        return u <= 1 && global.lan == "en-gb" && (r = r.slice(0, r.length - 1)), r;
    },
    getValueIndicator:function(n, t) {
        return (oddsUtil.indicator = 0, n == t) ? oddsUtil.indicator :(uv.ov == 3 ? n == 0 ? oddsUtil.indicator = 1 :n > 0 && t < 0 ? oddsUtil.indicator = 1 :n < 0 && t > 0 ? oddsUtil.indicator = 2 :n > 0 && t > 0 && n < t ? oddsUtil.indicator = 1 :n > 0 && t > 0 && n > t ? oddsUtil.indicator = 2 :n < 0 && t < 0 && n > t ? oddsUtil.indicator = 2 :n < 0 && t < 0 && n < t && (oddsUtil.indicator = 1) :oddsUtil.indicator = n < t ? 1 :2, 
        oddsUtil.indicator);
    },
    isFavouriteTeam:function(n, t, i) {
        var r = 0;
        if (t > 1 && (r = (t - 1) * 8), n != null) {
            if (homeSelectionHdp = n[r + 1], awaySelectionHdp = n[r + 3], homeSelectionHdp == null && awaySelectionHdp == null || homeSelectionHdp == 0 && awaySelectionHdp == 0) return !1;
            if (homeSelectionHdp.substr(0, 1) == "-") return i ? !0 :!1;
            if (awaySelectionHdp.substr(0, 1) == "-") return i ? !1 :!0;
        }
        return !1;
    },
    isInMyCompetitions:function(n) {
        var t = parseInt(n), i = LPM.mycomps;
        return _.includes(i, t);
    },
    isFtHtFavouriteTeam:function(n, t, i, r) {
        var e = 0, u, f;
        if (i > 1 && (e = (i - 1) * 8), n != null) {
            if (u = n[e + 1], f = n[e + 3], u == null && f == null || u == 0 && f == 0) return !1;
            if (u.substr(0, 1) == "-") return r ? !0 :!1;
            if (f.substr(0, 1) == "-") return r ? !1 :!0;
        }
        if (t != null) {
            if (u = t[e + 1], f = t[e + 3], u == null && f == null || u == 0 && f == 0) return !1;
            if (u.substr(0, 1) == "-") return r ? !0 :!1;
            if (f.substr(0, 1) == "-") return r ? !1 :!0;
        }
        return !1;
    ...
    getLockIcon:function(n) {
        ...
        oddsUtil.netLockIcon = oddsUtil.netLockIcon.replace("{0}", "singleVal")), oddsUtil.netLockIcon) :(oddsUtil.lockIcon == null && (oddsUtil.lockIcon = TrimPath.processDOMTemplate("lockIcon", null), 
        oddsUtil.lockIcon = oddsUtil.lockIcon.replace("{0}", "")), oddsUtil.lockIcon);
    },
    GetPeriodLocalization:function(n, t) {
        if ((global.lan == "zh-cn" || global.lan == "zh-tw" || global.lan == "en-gb") && n != "ot") return "";
        switch (n) {
          case "q1":
            return l.Period_1Q;
    ...
    GetPeriodText:function(n) {
        switch (n) {
          ...
          case "s1":
            return global.lan == "vi-vn" || global.lan == "id-id" ? "Set 1" :l.Period_1S;

          case "s2":
            return global.lan == "vi-vn" || global.lan == "id-id" ? "Set 2" :l.Period_2S;

          case "s3":
            return global.lan == "vi-vn" || global.lan == "id-id" ? "Set 3" :l.Period_3S;

          case "s4":
            return global.lan == "vi-vn" || global.lan == "id-id" ? "Set 4" :l.Period_4S;

          case "s5":
            return global.lan == "vi-vn" || global.lan == "id-id" ? "Set 5" :l.Period_5S;

          case "s6":
            return global.lan == "vi-vn" || global.lan == "id-id" ? "Set 6" :l.Period_6S;

          case "s7":
            return global.lan == "vi-vn" || global.lan == "id-id" ? "Set 7" :l.Period_7S;
    ...
    GetEventTimer:function(n) {
        if (global.lan == "th-th" || global.lan == "vi-vn" || global.lan == "id-id" || global.lan == "ko-kr" || global.lan == "pt-br" || global.lan == "en-gb" && (n.toUpperCase() == "ET" || n.toUpperCase() == "PENS")) return n;
    ...
    GetEventTimerTooltip:function(n) {
        if ((global.lan == "en-gb" || global.lan == "zh-cn" || global.lan == "zh-tw") && n.toUpperCase() != "PENS" && n.toUpperCase() != "OT") return "";
        switch (n.toUpperCase()) {
          case "1H":
          case "H1":
            return l.ti1H;
    ...
    GetOULocalization:function(n) {
        if (global.lan == "zh-cn") switch (n.toLowerCase()) {
          case "o":
            n = l.o;
            break;
    ...
    GetCurrentScore:function(n, t, i, r) {
        var u;
        return u = i == 3 ? "p" :i == 2 ? "ft" :t, n = _.find(n, function(n) {
            return n.p == u;
    ...
    GetTotal:function(n, t, i) {
        var u, r;
        return u = t == 3 ? "ftg" :"p", n = _.find(n, function(n) {
            return n.p == u;
        }), i ? (r = "", n && (r = +n.h + +n.a), "(" + r + ")") :n ? n.h + "-" + n.a :"-";
    },
    HideSetScore:function(n, t, i) {
        var r = +n.substr(1);
        if (isNaN(r) && n.substr(0) != "s") return !0;
        if (i == 3) {
            if (r < t) return !0;
    ...
    tryRelaodInplay:function() {
        for (var r = $("#s1 .timer"), t, i, n = 0; n < r.length; n++) if (t = r.eq(n).text(), 
        t != "" && (i = t.split(":")[0], !isNaN(i) && i > om.ttih)) {
            location.reload();
            break;
        }
    },
    processData:function() {
        var u = function(t) {
            var r, f, u, i, e;
            if (om.tthi = t.tthi, t.ec == 0) {
                i = "/" + global.lan + "/sports";
                cCtrl.loadContent(i, !0);
                return;
            }
            if (r = t.d, f = !1, t.d instanceof Array) for (r = t.d[0], u = 0; u < t.d.length; u++) if (t.d[u].c != null && t.d[u].c.length > 0) {
                f = !0;
                break;
            }
            ...
            if (oddsPage.initParams(), o.vars.maxTimer = t.r, o.stateObjs.bts = t.bt, o.param.IsInplay ? o.$centerPanel.addClass("inplay").removeClass("non-inplay") :o.$centerPanel.addClass("non-inplay").removeClass("inplay"), 
            t.d != null && f) o.$containerWrapper[0].innerHTML = "", o.$myEventsContainer[0].innerHTML = ""; else {
            ...
            if (u = !0, t.d instanceof Array) for (r = 0; r < t.d.length; r++) if (t.t == 1 && !t.d[r].c) {
                u = !1;
                break;
            }
            u || (i = cCtrl.getLocation(), f = i.pathname + i.search, isIE9AndBelow && (f = i.url.path + i.url.query), 
            ...
            if (l) {
                if (l.sportId && l.data) a = l.sportId, l = l.data; else if (l.sportId) {
                    u = t(l.sportId, h);
                    o.hasMatch = !0;
                ...
                switch (v) {
                  case 1:
                    ...
                    l.c && l.c.length > 0 ? utility.template("OddsPage/" + l.tn, function(e) {
                        ...
                        f ? u && u.length != 0 ? (a = u.next(), y = a.prop("id"), a && a.length > 0 && y == (h ? "mesc" :"sc").concat(l.k) ? a[0].innerHTML = v :(t(l.k, h).remove(), 
                        a = $(i(l.k, h, v)), a.insertAfter(u)), u = a) :(t(l.k, h).remove(), u = $(i(l.k, h, v)), 
                  ...
                  case 2:
                    if (o.hasMatch = !0, u = t(l.k, h), h) return;
                    e(l, u);
            ...
            } else o.hasMatch || oddsPage.showNoMatch(), y = o.param.IsFirstLoad, setTimeout(function() {
                ScrollerBar.initScrollbarStatus();
                y && ScrollerBar.scrollToTop();
            }, 50), c && typeof c == "function" && c(), om.logUtil.logTotalTime("SportOddsOM.js - rendering finished"), 
            oddsPage.showLoading(!1), cCtrl.isProcessing = !1, r = null, u = null, c = null;
        }, i = function(n, t, i) {
            ...
            for (var i, s, r, g, nt, h, tt, it, c, p, u, f, e, ft, w, v, b, k, y, a = 0; a < n.d.length; a++) if (i = n.d[a], 
            ...
            s) {
                ...
                switch (i[0].substr(0, 2)) {
                  ...
                  case "sh":
                  case "sa":
                    r.hasClass("fb") ? (g = i[0].substr(2, i[0].length - 1), $((i[0].substr(0, 2) == "sh" ? "#sa" :"#sh") + g).removeClass("fontWeight-bold"), 
                  ...
                  case "tm":
                    ...
                    $.each(o.stateObjs.timers, function() {
                        ...
                        if (this.id.indexOf(i[0]) != -1) {
                            if (nt = !0, u = h[1] && h[1] != "" ? h[1] :"", u != "" && r.prev("span.period").text(n.k == 2 ? l["sti" + u.toUpperCase()] :u).attr("title", oddsUtil.GetEventTimerTooltip(u)), 
                            n.k != 2) if (u == "HT" || u == "Pens") for (f in o.stateObjs.times) o.stateObjs.times.hasOwnProperty(f) && (t = o.stateObjs.times[f], 
                            t.tm == this.id && (t.id = i[0], t.tmrText = "&nbsp;", t.s = null)); else if (e = h[0].split(":"), 
                            e.length != 2) o.stateObjs.times[this.id] = {
                                id:i[0],
                                tmrText:h[0],
                                tm:i[0]
                            }, r.next().text(""); else if (e[0] = new Number(e[0]), s = new Number(e[1]), c = new Number(e[0]), 
                            s = s < 0 ? 0 :s, c = c < 0 ? 0 :c, n.k == 1) {
                                v = this.id;
                                for (f in o.stateObjs.times) o.stateObjs.times.hasOwnProperty(f) && (t = o.stateObjs.times[f], 
                                t.tm == v && (t.id = i[0], t.m = c, t.s = s));
                  ...
                  case "fs":
                    i[1] === "" ? r.text("").parent().addClass("hidden") :(p = i[1].split("|"), r.length > 0 && r.text("(" + p[0] + "-" + p[1] + ")").parent().hasClass("hidden") && r.parent().removeClass("hidden"));
                    break;

                  case "sb":
                    i[0].length > 0 && i[1] && (u = JSON.parse(i[1]), f = n.k, e = u.k, f == 2 ? (r.text(oddsUtil.GetCurrentScore(u.ps, u.cp, f, !0)), 
                    $("#sa" + e).text(oddsUtil.GetCurrentScore(u.ps, u.cp, f, !1)), ft = u.ct ? u.ct :"", 
                    w = u.cp ? u.cp :"", $("#tm" + e).text(u.ct).prev("span.period").text(l["sti" + w.toUpperCase()]).attr("title", oddsUtil.GetEventTimerTooltip(w))) :($("#ph" + e).text(oddsUtil.GetCurrentScore(u.ps, u.cp, f, !0)), 
                    $("#pa" + e).text(oddsUtil.GetCurrentScore(u.ps, u.cp, f, !1)), $("#svh" + e)[u.s == 1 ? "addClass" :"removeClass"]("serve"), 
                    $("#sva" + e)[u.s == 0 ? "addClass" :"removeClass"]("serve"), v = $("#" + u.cp + "-" + e), 
                    ...
                    }), $("#total" + e).text(oddsUtil.GetTotal(u.ps, f, !1)), $("#sum" + e).text(oddsUtil.GetTotal(u.ps, f, !0))));
                    break;
                  ...
                  default:
                    ...
                    o.stateObjs.$upObjs.push(s)) :k == 2 && (om.odds.removeUpDownObjById(s.id), o.stateObjs.$downObjs.push(s)));
                    var rt = r.prev("span.ou").attr("ou"), ut = rt ? rt.toLowerCase() :"", d = o.$myEventsContainer.find("#s" + n.k);
                    ...
                    y.attr("hdp", i[1]), r.hasClass("hidden") || (o.param.OddsType == 1 ? y.html(i[1]) :y.html(i[1].replace("+", "").replace("-", "")))) :r.hasClass("locked") || r.html(i[1]);
            ...
            n = om.pagination;
            n.$container || (n.$container = $("#pagination"), n.$btnPrev = $("#p-prev"), n.$btnNext = $("#p-next"), 
            n.$currPage = $("#p-current-page"), n.$maxPage = $("#p-max-page"), n.$opt = $("#p-options"), 
            n.$pageBtn = $("#p-pg-btn"), n.$bkTop = $("#p-top"));
            !o.totalPages || o.totalPages <= 1 ? n.$container.addClass("hidden") :(n.$container.removeClass("hidden"), 
            n.$currPage.text(o.param.PageNo + 1), n.$maxPage.text(o.totalPages));
            n.$bkTop.on("click", function() {
                ScrollerBar.scrollToTop();
            });
            for (u = n.$opt.find("ul"), u.empty(), i = new StringBuilderEx(), t = 0; t < o.totalPages; t++) {
                var f = t == o.param.PageNo, e = t + 1 + " / " + o.totalPages, s = "<li" + (f ? " class=actived" :"") + " data-val=" + t + ">";
                i.append(s);
                i.append(e);
                i.append("</li>");
                u.html(i.toString());
            ...
            u.unbind("click").on("click", "li", function(t) {
                var i = $(this).data("val"), u = parseInt(i, 10) + 1;
            ...
            parseInt(o.param.PageNo, 10) + 2 > o.totalPages ? n.$btnNext.addClass("disabled").unbind("click") :n.$btnNext.removeClass("disabled").unbind("click").click(function(t) {
                var i = isNaN(parseInt(o.param.PageNo, 10)) ? 1 :parseInt(o.param.PageNo, 10) + 1, u = parseInt(i, 10) + 1;
            ...
            if (isIE9AndBelow && (o = r.url.path, t = r.url.query), t.length) {
                for (u = t.slice(1).split("&"), f = "?", i = 0; i < u.length; i++) u[i].indexOf("pageno") == -1 && (f = f + u[i] + "&");
                t = f + "pageno=" + n;
            } else t = "?pageno=" + n;
            e = o;
            e += t;
    ...
    odds:function() {
        var n = function(n) {
            var t, i, r;
            if (n.hd != null && typeof n.hd != "undefined") for (t = 0; t < n.hd.length; t++) i = document.getElementById(n.hd[t]), 
            r = $(i), i && r.html() && !r.hasClass("closed") && o.stateObjs.$downObjs.push(i);
            if (n.hu != null && typeof n.hu != "undefined") for (t = 0; t < n.hu.length; t++) i = document.getElementById(n.hu[t]), 
            r = $(i), i && r.html() && !r.hasClass("closed") && o.stateObjs.$upObjs.push(i);
        }, t = function() {
            ...
            var r, t, i;
            for (n || (n = opSetting.GetHighlightIds()), r = n.length, t = 0; t < r; ++t) i = n[t], 
            $o = o.$mainOddsPanel.find("#o" + i), $o.length > 0 && $o.parents("td").addClass("selected"), 
            $o = o.$mainOddsPanel.find(".secondRow #o" + i), $o.length > 0 && $o.parents("td").addClass("selected");
        };
        return {
    ...
    state:function() {
        var t = function(n) {
            ...
            while (n.hasClass("event")) t ? n.removeClass("hidden") :n.addClass("hidden"), n = n.next();
        };
        return {
    ...
    timerUtil:function() {
        var t = function() {
            ...
            o.stateObjs.times = [];
            o.stateObjs.timers = [];
            o.param.IsInplay && (o.stateObjs.timers = o.$mainOddsPanel.find("span.timer"), $.each(o.stateObjs.timers, function() {
                var t = $(this), i = t.attr("class").split(" ")[1], n, r;
                this.innerHTML == "45:00" && t.next().text() == "HT" ? o.stateObjs.times[this.id] = {
                    id:this.id,
                    tmrText:"45:00",
                    tm:i
                } :(n = this.innerHTML.split(":"), n.length != 2 || t.hasClass("static") ? o.stateObjs.times[this.id] = {
                    id:this.id,
                    tmrText:this.innerHTML,
                    tm:i
                } :(n[0] = Math.abs(n[0]), n[1] = Math.abs(n[1]), r = {
                    id:this.id,
                    m:new Number(n[0]),
                    s:new Number(n[1]),
                    tm:i
            ...
            if (n) return n.s != null ? (n.s += 1, n.s == 60 && (n.m += 1, n.s = 0), (n.m < 10 ? "0" + n.m :n.m) + ":" + (n.s < 10 ? "0" + n.s :n.s)) :typeof n.tmrText != "undefined" && n.tmrText != null ? n.tmrText :n;
        };
        return {
            setTimer:t,
            clearTimer:n,
        ...
        return {
            ...
            getVersion:function() {
                ...
                return _.size(n) != 1 || o.param.IsInplayAll ? (_.forIn(n, function(n) {
                    t += n.concat("|");
                }), t = t.slice(0, -1)) :(t = n[Object.keys(n)[0]], t = t.split(",")[1]), t;
            }
        };
    }(),
    handler:function() {
        var t = function(t) {
            ...
            if (i.hasClass("icon-Stats")) {
                var s = i.hasClass("icon-Stats") ? utility.parsePopupInfo("popup-new w1065 h790") :utility.parsePopupInfo("popup-new w810 h560"), g = screen.width / 2 - s.width / 2, nt = screen.height / 2 - s.height / 2 * 1.1, tt = "center=yes,resizable=" + (i.hasClass("tvip") ? "no" :"yes") + ",scrollbars=yes,  width=" + s.width + ", height=" + s.height + ",left=" + g + ",top=" + nt, h = "";
                ...
                if (i.hasClass("bg")) {
                    if (uv.cdbg && (e = i.attr("cc-info"), e != undefined && e != "" && e != null)) {
                        var u = e.split("|"), v = u[0], y = u[1], p = u[2], w = u[3], b = u[4], k = u[5];
                ...
                if (i.hasClass("tvip")) {
                    if (uv.cdbg && i.hasClass("bgs")) {
                        if (e = i.attr("cc-info"), e != undefined && e != "" && e != null) {
                            var u = e.split("|"), v = u[0], y = u[1], p = u[2], w = u[3], b = u[4], k = u[5];
                            Action.RightPanel.TV.playTvIgnoreLock(v, y, p, w, b, k, uv.login);
                            lockInfo.isLock && liveCentreControl.saveLockInfo(v, y, p, w, ccparam.lang, b, k);
                        }
                    } else {
                        var s = utility.parsePopupInfo("popup-new w810 h598"), g = screen.width / 2 - s.width / 2, nt = screen.height / 2 - s.height / 2, tt = "center=yes,resizable=" + (i.hasClass("tvip") ? "no" :"yes") + ",scrollbars=yes,  width=" + s.width + ", height=" + s.height + ",left=" + g + ",top=" + nt, h = "";
                        h = pm.parentOrLocalHost() + "/" + global.lan + "/live-streaming";
                        l = i.attr("url").split("/live-streaming");
                        h = h + l[1];
                        a = i.hasClass("tvip") ? "stream" :"_blank";
                ...
                if (i.hasClass("fve")) myEvents.toggleMyEventsByEvent(i); else if (i.hasClass("fvc")) myEvents.toggleMyEventsByCompetition(i); else {
                    if (i.hasClass("comp-fav")) return it = i.hasClass("cpIcon") ? i :i.parent(), ft = it.attr("id").substr(2), 
                    ...
                    if (i.hasClass("childExp") || i.hasClass("icon-ArrowUp") || i.hasClass("icon-ArrowDown")) o.vars.isCollapsing || (o.vars.isCollapsing = !0, 
                    c = i.parents(".childTitle"), rt = c.parent(), r = c.attr("id"), c.hasClass("collapsed") ? (c.removeClass("collapsed"), 
                    d = rt.next(), om.state.showHideChildEvt(d, !0), setTimeout(function() {
                        ScrollerBar.initScrollbarStatus();
                    }, 100), n(o.stateObjs.$collapsedObjsChild, r), o.stateObjs.$expandObjsChild.push(r)) :(c.addClass("collapsed"), 
                    d = rt.next(), om.state.showHideChildEvt(d, !1), setTimeout(function() {
                        ScrollerBar.initScrollbarStatus();
                    }, 100), o.stateObjs.$collapsedObjsChild.push(r), n(o.stateObjs.$expandObjsChild, r)), 
                    o.vars.isCollapsing = !1); else if (i.hasClass("btn-toggle") || i.hasClass("toggle-arrow")) {
                        if (!o.vars.isCollapsing && (o.vars.isCollapsing = !0, et = i.hasClass("child"), 
                        et)) {
                            var ot = i.parents(".child-title"), f = i.closest("span.btn-toggle"), r = f.attr("id"), st = i.closest("tbody");
                            f.hasClass("expand") ? (ot.nextAll().hide(), ut = st.nextUntil(".firstEvt"), o.stateObjs.$collapsedObjsChild.push(r), 
                            om.removeFromArray(o.stateObjs.$expandObjsChild, r), f.removeClass("expand"), o.vars.isCollapsing = !1) :(ot.nextAll().show(), 
                            ut = st.nextUntil(".firstEvt"), om.removeFromArray(o.stateObjs.$collapsedObjsChild, r), 
                            o.stateObjs.$expandObjsChild.push(r), f.addClass("expand"), o.vars.isCollapsing = !1);
                        }
                    } else (i.hasClass("competitionName") || i.hasClass("tableContainer") || i.hasClass("cpn")) && (o.vars.isCollapsing || (o.vars.isCollapsing = !0, 
                    f = i.closest(".competitionName"), r = f.attr("id"), f.hasClass("expand") ? (f.removeClass("expand"), 
                    o.stateObjs.$collapsedObjs.push(r), n(o.stateObjs.$expandObjs, r), f.next().hide("blind", function() {
                        o.vars.isCollapsing = !1;
                        ScrollerBar.initScrollbarStatus();
                    })) :(f.addClass("expand"), n(o.stateObjs.$collapsedObjs, r), o.stateObjs.$expandObjs.push(r), 
            ...
            if ((i.hasClass("net") && (i = i.children().last()), h = i.html(), h != "") && (f = i.attr("id"), 
            f != undefined && f != "")) {
                var r = i.parents("div.event"), t = r.attr("id"), y = r.attr("pid"), p = r.attr("ctid");
                p == window.o.pacType.pelAH && (c = i.parent().parent(), (c.hasClass("td-odds-ou-odds") || c.hasClass("td-odds-ouSecond-odds")) && ($evts = r.nextUntil(".hidden"), 
                $evts.length === 0 ? t = r.next().attr("id") :(t = $evts.last().next().attr("id"), 
                t === undefined && (t = r.attr("id")))));
                t = t.substring(1);
                u = "";
                i.parent().parent().hasClass("td-odds-teamOu-odds") && (u = t, t = i.parents("tr").attr("tid").substring(1));
                e = o.$mainOddsPanel.find("#" + f.replace("o", "h")).attr("hdp");
                (e == "" || e == undefined) && (e = null);
                t && t.indexOf("_") != -1 && o.param.IsInplay && (t = t.split("_")[0]);
                var a = u == "" ? o.$mainOddsPanel.find("#sh" + t) :o.$mainOddsPanel.find("#sh" + u), v = u == "" ? o.$mainOddsPanel.find("#sa" + t) :o.$mainOddsPanel.find("#sa" + u), w = a.html() === undefined ? null :a.html(), b = v.html() === undefined ? null :v.html(), k = w + ":" + b;
            ...
            var t = $(this), i = t.parents("tbody").find(".td-teameName").addClass("darkerHover").end().data("amkt");
            o.$mainOddsPanel.find("#" + i).addClass("hover");
            n.stopPropagation();
        }, e = function(n) {
            var t = $(this), i = t.parents("tbody").find(".td-teameName").removeClass("darkerHover").end().data("amkt");
    ...
    filter:function() {
        return {
            isSelectedFilterType:function(n) {
                ...
                return t && t.length > 0 && (i = t.split(","), $.inArray(n, i) != -1) ? !0 :!1;
            },
            ...
            addFilterTypeToCookie:function(n) {
                ...
                t && t.length > 0 ? (i = t.split(","), r = _.union(i, [ n ]), t = r.join(",")) :t = n;
                utility.cookie.write(o.FILTER_TYPE, t, 730);
            },
            removeFilterTypeFromCookie:function(n) {
                var t = utility.cookie.read(o.FILTER_TYPE), i;
                t && t.length > 0 && (i = t.split(","), _.remove(i, function(t) {
                    return t == n;
    ...
    findTheFirstAvaiableBg:function(n) {
        ...
        if (n.c && n.c.length > 0) for (i = 0; i < n.c.length; i++) {
            if (u) break;
            for (f = n.c[i].e, r = 0; r < f.length; r++) if (t = f[r], t.ibs && t.ibsc) {
                u = !0;
                break;
            }
        }
        u ? (e = t.cei.ctid == 0 ? t.k :t.pk, om.isFoundBg = !0, liveCentreControl.saveDefaultBgInfo(e, t.i[0], t.i[1], n.k, global.lan, t.i[7], t.pvdr)) :(liveCentreControl.clearDefaultBgInfo(), 
        ccparam.playingLsId == "" && (ccparam.playingEventId = ""));
    },
    playCC:function() {
        o.param.IsInplay && Action.RightPanel.TV.playTvDefault(function(n) {
            var t;
            if (n) om.isPlayingCC = !0, om.havePlayingTv = !0, om.isFoundBg || (t = liveCentreControl.getDefaultBgInfo(), 
            t && liveCentreControl.clearDefaultBgInfo()); else if (om.isFoundTv = !1, t = liveCentreControl.getDefaultBgInfo(), 
            om.isFoundBg) {
                if (om.isFoundBg) {
                    if (om.isPlayingCC) {
                    ...
                    om.isPlayingCC = !0), om.havePlayingBg = !0);
                }
            } else {
            ...
            om.isPlayingCC = !1), om.isPlayingCC) {
                liveCentreControl.getEnlargeStatus() && setTimeout(function() {
                    Action.RightPanel.resize(!0);
                }, 500);
                return;
...
myEvents = function() {
    var n = $("#myEventTitle"), y = $("#myEventCount"), i = $($("#myEventsEmptyMsg").text()), p = function(t) {
        if (n[t ? "removeClass" :"addClass"]("hidden"), o.$myEventsContainer[t ? "removeClass" :"addClass"]("hidden"), 
        t) {
        ...
        n.hasClass("collapsed") ? (n.removeClass("collapsed"), o.$myEventsContainer.find(".event").length == 0 ? o.$myEventsContainer.append(i).removeClass("hidden myFavHasEvent") :o.$myEventsContainer.removeClass("hidden")) :(n.addClass("collapsed"), 
        ...
        i = a(t, !0), u ? nt(f, t) :_.forEach(i, function(n) {
            r(f, t, n, o.$containerWrapper, o.$myEventsContainer, !1);
        }), c(i)) :(u = o.$myEventsContainer.find("#" + t + " .event").length == 0, i = a(t, !1), 
        u ? g(f, t) :_.forEach(i, function(n) {
            r(f, t, n, o.$myEventsContainer, o.$containerWrapper, !0);
        }), h(i));
        n = null;
    }, s = function(n, t) {
        var s = n.parent(), u = n.data("meinfo").split("_"), f = u[0], e = u[1], i = +u[2];
        s.hasClass("actived") ? (r(f, e, i, o.$containerWrapper, o.$myEventsContainer, !1), 
        c(i, t), n.attr("title", l.OP_AddMyEvents)) :(r(f, e, i, o.$myEventsContainer, o.$containerWrapper, !0), 
        h(i));
        n = null;
    }, k = function(n) {
        ...
        w = h.map(function() {
            var n = $(this), t = n.data("gtid");
            if (n.hasClass("event") && !_.isUndefined(t)) return "gt" + t;
        }), _.remove(h, function(n) {
            var t = $(n);
            return !t.hasClass("event") && _.indexOf(w, n.id) == -1;
        }), c.html(h)), s.find('.event[pid="' + r + '"]').remove());
        it(s);
        t(n, i, !0);
        f();
        t(n, i, !1);
        ...
        var r = (t ? o.$myEventsContainer :o.$containerWrapper).find("#" + n + " .event"), i = [];
        ...
        t.each(function(n) {
            var t = $(this), f;
            if (t.hasClass("event")) {
                if (e = +t.data("odr"), h < e) return o || u == 0 || (i = document.getElementById("gt" + u), 
                i && (i = i.cloneNode(!0))), r = n, !1;
            } else t.hasClass("child") && (f = t.prop("id"), f.slice(2) == u && (o = !0, t.children(".childTitle").hasClass("collapsed") && (s = !0)));
        });
        r == 0 && h > e ? (o || (i = document.getElementById("gt" + u)), i ? (t.push(i.cloneNode(!0)), 
        $(i).children(".childTitle").hasClass("collapsed") && n.addClass("hidden")) :s && n.addClass("hidden"), 
        t.push(n[0])) :(f = $(t[r - 1]), f.length > 0 && f.hasClass("child") && f.prop("id").slice(2) != u && (r = r - 1), 
        i ? ($(i).children(".childTitle").hasClass("collapsed") && n.addClass("hidden"), 
        t.splice(r, 0, i, n[0])) :(s && n.addClass("hidden"), t.splice(r, 0, n[0])));
    }, it = function(n) {
        var t = n.find(".child"), i = _.remove(t, function(t) {
        ...
        var r = (i ? o.$myEventsContainer :o.$containerWrapper).find("#" + n), u = (i ? o.$myEventsContainer :o.$containerWrapper).find("#" + t), f = r.find(".event").length == 0, e = u.find(".event").length == 0;
        r[f ? "addClass" :"removeClass"]("hidden");
        u[e ? "addClass" :"removeClass"]("hidden");
    }, f = function() {
        var t = o.$myEventsContainer.find(".event").length;
        t == 0 ? (n.find(".removeAll").addClass("hidden"), o.$myEventsContainer.append(i).removeClass("myFavHasEvent hidden")) :(n.removeClass("collapsed").find(".removeAll").removeClass("hidden"), 
        o.$myEventsContainer.addClass("myFavHasEvent").removeClass("hidden"), i.remove());
    }, u = function() {
        var n = o.$myEventsContainer.find(".fve"), t = _.map(n, function(n) {
...
$(function() {
    OddsHeader.container || (OddsHeader.container = $("#oddsHeaderContainer"), OddsHeader.ddl_odds = $("#ddl_odds"), 
    OddsHeader.ddl_oddsOpt = $("#ddl_oddsFmtOptions1"), OddsHeader.ddl_oddsDisplay = $("#ddl_oddsFmtDisplay1"), 
    OddsHeader.ddl_sortBy = $("#ddlSortBy"), OddsHeader.ddl_sortIcon = $("#sortIcon"), 
    OddsHeader.ddl_sortOpt = $("#sortByOpt"), OddsHeader.ddl_market = $("#ddlMarket"), 
    OddsHeader.ddl_marketOpt = $("#ddlMarketOpt"), OddsHeader.pager = $("#p-pg-btn"));
...
OddsHeader = {
    ...
    hideAllDDL:function(n) {
        ...
        t = $("#quickMenu"), t.hasClass("collapsed") || n != undefined && n.id == t.attr("id") || t.toggleClass("collapsed"), 
        i = $("#betType"), i.hasClass("collapsed") || n != undefined && n.id == i.attr("id") || i.toggleClass("collapsed"));
    },
    initOddsDDL:function() {
        ...
        OddsHeader.ddl_oddsOpt.on("click", "li", function() {
            ...
            utility.service("OddsService", "UpdateOddsType", OddsHeader.setting.param, "GET", function(i) {
                i.suc && (settingParam.oddsType = uv.ov = t, OddsHeader.saveToCookie(), oddsUtil.SetOddsTypeCss(), 
                cCtrl.reloadPage(), OddsHeader.ddl_oddsDisplay.html(n.data("sel")), n.siblings().removeClass("actived"), 
                n.addClass("actived"));
            });
        });
    ...
    reInitHeaderDDLs:function() {
        ...
        if (u != null) for (i = u.split("&"), t = 0; t < i.length; t++) {
            n = i[t].split("=");
            switch (n[0]) {
              case "OddsType":
                r = n[1];
    ...
    initFilterButton:function(n) {
        var c = "1h_", l = "st_", i, r, f, e, s, h, t = o.$mainOddsPanel.find('[id="s' + n + '"]'), u = function(i, r) {
            var u = $(this);
            r ? (i.data.addClass("activated"), t.addClass(u.attr("id"))) :(u.hasClass("activated") ? (i.data.removeClass("activated"), 
            t.removeClass(u.attr("id")), om.filter.inactivateFilter(u.attr("id") + n)) :(i.data.addClass("activated"), 
            t.addClass(u.attr("id")), om.filter.activateFilter(u.attr("id") + n)), ScrollerBar.initScrollbarStatus());
            i.stopPropagation();
            i = null;
        }, a, v, y, p;
        switch (n) {
          case 1:
            ...
            OddsHeader.$filter_half.off("click").on("click", OddsHeader.$filter_half, function(i, r, u) {
                ...
                r || (om.filter.activateFilter(c + n), om.filter.inactivateFilter(l + n));
            ...
            OddsHeader.$filter_standard.off("click").on("click", OddsHeader.$filter_standard, function(i, r, u) {
                ...
                r || (om.filter.activateFilter(l + n), om.filter.inactivateFilter(c + n));
          ...
          case 27:
            ...
            var w = f.attr("id") + n, b = e.attr("id") + n, k = s.attr("id") + n;
    ...
    QuickMenuDDL:function() {
        var t = null, n = null, i = function() {
            ...
            }), r.mc = LPM.mycomps, t = r.sn, utility.template("OddsPage/" + u, function(t) {
                f.html(t.process(r));
                setTimeout(ScrollerBar.initQuickMenuScrollbar, 100);
                n.removeClass("collapsed");
            }, u)) :n.addClass("collapsed"), OddsHeader.hideAllDDL(this));
            i.stopPropagation();
        }, u = function(i) {
            var r = $(this), f, e;
            if (r.hasClass("mycomp")) {
                var u = r.toggleClass("actived").parents(".qmopt"), o = u.data("cid"), s = u.data("cn");
                Action.LeftPanel.MyCompetition.toggle({
                    sid:selobj.spt,
                    sn:t,
                    cid:o,
            ...
            } else f = r.data("key"), e = r.data("ct"), +e == 0 ? (r.find(".hidden").removeClass("hidden"), 
            ScrollerBar.initQuickMenuScrollbar()) :(n && n.addClass("collapsed"), Action.MainOdds.QuickMenu.changeOption(f, selobj.sptn, r.data("cid")));
            i.stopPropagation();
        };
        return {
            init:i
    ...
    BetTypeDDL:function() {
        var n = function() {
            ...
            if (r.hasClass("collapsed")) {
                if (i.length > 0) for (t = 0; t < i.length; t++) u.appendFormat('<li class="btopt {0}" data-val="{1}"><table><colgroup><col><col class="col-fixed1"></colgroup><tbody><tr><td class="pd-0"><span class="lht-1p1 dsp-iblk mg-t-3">{2}<span></span></span></td><td class="height-37"></td></tr></tbody></table></li>', i[t].k == selobj.btp2 ? "actived" :"", i[t].k, oddsUtil.CustomizedBettypeName(selobj.spt, i[t].sk, i[t].n));
                f.html(u.toString());
                r.removeClass("collapsed");
                u = null;
            } else r.addClass("collapsed");
            OddsHeader.hideAllDDL(this);
            n.stopPropagation();
        }, i = function(n) {
            var i = $(this), t = i.attr("data-val");
...
AMStore = {
    createNew:function() {
        function nt(n, t, i) {
            for (var u = [], e, f, r = 0; r < t * i; r++) e = $.grep(n, function(n) {
                return n[3] == r;
            })[0], typeof e != "undefined" ? u.push(e) :u.push([ "", "", "", r ]);
            for (u = u.concat(n.filter(function(n) {
                return n[3] == 999;
            })), f = u.length, r = 1; r < Math.ceil(f / i); r++) while (f % i != 0) u.push([ "", "", "", "999" ]), 
            f++;
            return u;
        }
        function tt(n, t) {
            for (var u = [], c = n.filter(function(n) {
                return n[3] != 999;
            }), r = [], e = 0, s, f, h, o, i = 0; i < c.length; i++) s = c[i], f = +s[3] % t, 
            _.isArray(r[f]) || (r[f] = []), r[f].push(s), r[f].length > e && (e = r[f].length);
            if (_.forEach(r, function(n, t) {
                if (typeof n == "undefined" && (r[t] = n = []), e > n.length) while (e > n.length) n.push([ "", "", "", "999" ]);
            }), t > r.length) while (t > r.length) {
                for (h = [], i = 0; i < e; i++) h.push([ "", "", "", "999" ]);
                r.push(h);
            }
            for (_.forEach(_.zip.apply(this, r), function(n) {
                ...
                return n[3] == 999;
            })), o = u.length, i = 1; i < Math.ceil(o / t); i++) while (o % t != 0) u.push([ "", "", "", "999" ]), 
            o++;
            return u;
        }
        function c(n, t) {
        ...
        }, u = !0, k = 0, i = [], o = [], s = !1, d = localStorage.getItem("mmt"), ot = typeof d == "undefined" ? [] :JSON.parse(d), r = {
            filteredType:"|p|"
        }, f = !1, v = !1, y = {
            Up:[],
            Down:[]
        ...
        _cTimer = null;
        window._elapsed = 0;
        var w = 300, h = function(n) {
            var p, d, g, w, st, e, rt, ut, b, ft, et, o, y, f, ht, k, v, h, t, r, u, s;
            if (!n.odds || n.odds.length == 0) return n.odds;
            p = function(n) {
                return +n[1] != 0;
            };
            d = function(n) {
            ...
            switch (n.betType.slice(0, 2)) {
              ...
              case "ou":
                ...
                }).flatten().value(), (n.sid == 1 || n.sid == 2) && n.ctid == 0 ? _.chunk(g, 12) :_.chunk(g, 2);
              ...
              case "hf":
                var ct = [ n.home + " / " + n.home, n.home + " / " + l.Odds_Draw, n.home + " / " + n.away, l.Odds_Draw + " / " + n.home, l.Odds_Draw + " / " + l.Odds_Draw, l.Odds_Draw + " / " + n.away, n.away + " / " + n.home, n.away + " / " + l.Odds_Draw, n.away + " / " + n.away ], lt = _.chain(n.odds).chunk(2).map(function(n, t) {
                    return n.push(ct[t]), n;
                }).chunk(3).value(), it = new Array(3);
                for (t = 0; t < it.length; t++) it[t] = _.map(lt, function(n) {
                    return n[t];
                });
                return it;

              case "cs":
                var at = [ "1 - 0", "0 - 1", "2 - 0", "0 - 2", "2 - 1", "1 - 2", "3 - 0", "0 - 3", "3 - 1", "1 - 3", "3 - 2", "2 - 3", "4 - 0", "0 - 4", "4 - 1", "1 - 4", "4 - 2", "2 - 4", "4 - 3", "3 - 4", "0 - 0", "1 - 1", "2 - 2", "3 - 3", "4 - 4", l.Odds_AOS ], vt = [ "1 - 0", "0 - 1", "2 - 0", "0 - 2", "2 - 1", "1 - 2", "3 - 0", "0 - 3", "3 - 1", "1 - 3", "3 - 2", "2 - 3", "0 - 0", "1 - 1", "2 - 2", "3 - 3", l.Odds_AOS ], i = _.chain(n.odds).chunk(2).map(function(t, i) {
                    return t[2] = n.betType == "cs" ? at[i] :vt[i], t;
                ...
                }), i = _.flatten(i), w = [], v = Math.max(i[0].length, i[1].length, i[2].length), 
                t = 0; t < v; t++) i[0][t] = d(i[0][t]), i[1][t] = d(i[1][t]), i[2][t] = typeof i[2][t] == "undefined" ? [ "", "", "" ] :i[2][t], 
              ...
              case "sb":
                ...
                e = _.chain(n.odds).chunk(2).map(function(n, t) {
                    return n[2] = st[t], n;
                }).value(), _.indexOf([ "", "0", 0 ], n.bestOf) == -1) {
                    f = [];
                    rt = [];
                    switch (+n.bestOf) {
                      case 3:
              ...
              case "tg":
                var yt = [ l.odds_TG01, l.odds_TG23, l.odds_TG46, l.odds_Up7 ], pt = [ l.odds_TG0, l.odds_TG1, l.odds_TG2, l.odds_TG3UP ], i = _.chunk(n.odds, 2).map(function(t, i) {
                    return t[2] = n.betType == "tg" ? yt[i] :pt[i], t;
                });
                for (i = n.isInplay ? _.filter(i, p) :i, t = 0; t < 4 - i.length; t++) i.push([ "", "", "" ]);
                return i;
            }
            switch (n.betType.slice(0, 3)) {
              case "1x2":
                return ut = _.chunk(n.odds, 2), ut.concat(_.remove(ut, function(n, t) {
                    return t == 1;
                }));

              case "tts":
                return b = [ [], [] ], b[0] = n.odds[0] && n.odds[0].length > 0 ? _.chunk(n.odds[0], 2) :[ [  ], [  ], [  ] ], 
                b[1] = n.odds[1] && n.odds[1].length > 0 ? _.chunk(n.odds[1], 2) :[ [  ], [  ] ], 
                b;

              case "sco":
                for (ft = _.chunk(n.odds[0], 2).map(function(n) {
                    return n[1] = n[1].split("|"), _.flatten(n);
                }), et = _.chunk(n.odds[1], 2).map(function(n) {
                    return n[1] = n[1].split("|"), _.flatten(n);
                }), o = _.chain(ft.concat(et)).map(function(n) {
                    return n[1];
                }).uniq().map(function(t) {
                    var r = _.flatten(_.filter(ft, 1, t)), i = _.flatten(_.filter(et, 1, t)), f = _.flatten(_.filter(n.odds[2], 0, t.slice(1))), e = r.length > 0 ? r[2] :i[2], u = [ [ r[0], r[3] ], [ i[0], i[3] ], [ f[1], f[2] ] ];
                ...
                }).value(), f = _.result(_.remove(o, "k", "a2"), 0), ht = _.result(_.remove(o, "k", "h1"), 0), 
                y = _.remove(o, function(n) {
                    if (n.k.slice(0, 1) == "a") return n;
                }), o = _.sortBy(o, "fo"), y = _.sortBy(y, "fo"), k = [], v = Math.max(o.length, y.length), 
                t = 0; t < v; t++) k[t] = [ o[t], y[t] ];
                return k.push([ f, ht ]), k;
            }
            if (h = {
                ...
                if (_.indexOf(h.group1, n.mn) != -1) {
                    if (r = 1, u = n.odds.length, n.odds.length % r != 0) for (t = 0; t < r - u % r; t++) n.odds.push([ "", "", "" ]);
                    return _.chain(n.odds).map(function(n) {
                        var t = _.pullAt(n, 0);
                        return n.push(t[0]), n;
                    }).chunk(r).value();
                }
                if (_.indexOf(h.group2, n.mn) != -1) return r = 3, u = n.odds.length, n.odds.sort(c), 
                _.chain(tt(n.odds, r)).map(function(n) {
                    var t = _.pullAt(n, 0), i = _.pullAt(n, 2);
                    return n.push(t[0]), n.push(i[0]), n;
                }).chunk(r).value();
                if (_.indexOf(h.group3, n.mn) != -1) {
                    if (r = 3, u = n.odds.length, n.odds.length % r != 0) for (t = 0; t < r - u % r; t++) n.odds.push([ "", "", "" ]);
                    return _.chain(n.odds).map(function(n) {
                        var t = _.pullAt(n, 0);
                        return n.push(t[0]), n;
                    }).chunk(r).value();
                }
                if (_.indexOf(h.group4, n.mn) != -1) return r = 2, u = n.odds.length, n.odds.sort(c), 
                _.chain(tt(n.odds, r)).map(function(n) {
                    var t = _.pullAt(n, 0), i = _.pullAt(n, 2);
                    return n.push(t[0]), n.push(i[0]), n;
                }).chunk(r).value();
                if (_.indexOf(h.group5, n.mn) != -1) {
                    ...
                    var a = n.odds.filter(function(n) {
                        return n[3] != 999;
                    }), ot = a.length ? Math.ceil(a[a.length - 1][3] / r) :1, s = _.chain(nt(n.odds, ot, r)).map(function(n) {
                        var t = _.pullAt(n, 0), i = _.pullAt(n, 2);
                        return n.push(t[0]), n.push(i[0]), n;
                    }).chunk(r).value();
                    return s;
                ...
                return n.odds.length % 2 == 1 && n.odds.push([ "", "", "" ]), _.chain(n.odds).map(function(n) {
                    var i = _.pullAt(n, 0), t;
                    return n.push(i[0]), n.length == 5 && (t = [ n[2], n[3], n[0], n[1], n[4] ], n = t), 
                    n;
                }).chunk(2).value();
            }
            return n.odds;
        ...
        var it = function(n) {
            var t, u;
            if (n.d.c[0].e[0].hide) n.d.c[0].e[0].o = []; else {
                t = {
                    a:[ "tts", "sco" ],
                    b:[ "1st", "last" ],
                    bt:{
                ...
                _.forEach(t.a, function(i) {
                    _.forEach(t.b, function(r) {
                        ...
                        t.bt[i].mo = n.d.c[0].e[0].o[i + r].mo, r == "1st" ? t.bt[i].v[0] = n.d.c[0].e[0].o[i + r].v :t.bt[i].v[1] = n.d.c[0].e[0].o[i + r].v, 
                        delete n.d.c[0].e[0].o[i + r]);
                    });
                });
                t.bt.tts.f != "" && (n.d.c[0].e[0].o.tts = t.bt.tts);
                t.ags = _.remove(n.d.c[0].e[0]["n-o"], "mn", "AnytimeGoalScorer");
                t.bt.sco.f != "" && (n.d.c[0].e[0].o.sco = t.bt.sco, n.d.c[0].e[0].o.sco.v[2] = typeof t.ags[0] != "undefined" ? t.ags[0].o :[]);
                t = {};
                var r = n.d.k, s = n.d.c[0].e[0].cei.ctid, f = n.d.c[0].e[0].k, i = n.d.tn.split(":")[1] == "inplay", o = n.d.c[0].e[0].i[37], e = n.d.c[0].e[0].o.eps;
                e && (e = $.extend(e, {
                    mt:"eps",
                    k:f
                }), _.forEach(e.o, function(n) {
                    n = $.extend(n, [ n[1], n[2], n[0] ]);
                }), n.d.c[0].e[0].eps = e, delete n.d.c[0].e[0].o.eps);
            ...
            return n.d.c[0].e[0].cel != null && _.forEach(n.d.c[0].e[0].cel, function(t) {
                var c;
                if (!t.hide) {
                    var l = t.cei.n, b = t.i[0], k = t.i[1], v = t.k, s = t.cei.ctid, d = ut(s, i), y = t.i[10], p = t.i[11], e = {
                        a:[ "tts", "sco" ],
                        b:[ "1st", "last" ],
                        bt:{
                            tts:{
                    ...
                    _.forEach(e.a, function(n) {
                        _.forEach(e.b, function(i) {
                            typeof t.o[n + i] != "undefined" && (e.bt[n].f = t.o[n + i].f, e.bt[n].mo = t.o[n + i].mo, 
                            i == "1st" ? e.bt[n].v[0] = t.o[n + i].v :e.bt[n].v[1] = t.o[n + i].v, delete t.o[n + i]);
                        });
                    });
                    e.bt.tts.f != "" && (t.o.tts = e.bt.tts);
                    c = _.remove(t["n-o"], "mn", "AnytimeGoalScorer");
                    e.bt.sco.f != "" && (t.o.sco = e.bt.sco, t.o.sco.v[2] = typeof c[0] != "undefined" ? c[0].o :[]);
                    delete t.o.eps;
            ...
            }), delete u, _.remove(n.d.c[0].e[0].o, function(n) {
                return n == undefined;
            }), n.d.c[0].e[0].o = _.sortByAll(n.d.c[0].e[0].o, [ "mo", "mt", "n" ]), n.d.c[0].e[0].myo = _.remove(n.d.c[0].e[0].o, function(n) {
            ...
            if (n.mt == "spwos" && n.mo == 999) return w;
            if (uv.urView == "EURO") {
                var r = -1;
            ...
            switch (e.type) {
              case CONSTANTS.SITEREFRESH:
                ...
                k = e.data.selobj.evt;
                e.data.mbd != null && e.data.selobj.evt > 0 && (n = e.data.mbd, c = n.d.tn.split(":")[1] == "inplay", 
                $("#center-panel")[c ? "removeClass" :"addClass"]("non-inplay"), typeof n.d.c[0].e[0].o == "undefined" && (n.d.c[0].e[0].o = {}), 
                n = it(e.data.mbd), g = uv.ov, u && (r.filteredType = c || !c && n.d.k != 1 || n.d.fb.length <= 1 ? "" :""), 
                c && typeof n.d.c[0].e[0].i[5] != "undefined" && n.d.c[0].e[0].i[5] != "" && (n.d.k == 1 || n.d.k == 6) && (_cTimer = Timer.interval(1, function() {
                    window._elapsed++;
                    t();
              ...
              case CONSTANTS.ALLMARKETPAGE.SHOWHIDEFILTERBTN:
                ...
                a = h[0].scrollWidth > h[0].clientWidth, h.parent()[a ? "addClass" :"removeClass"]("mg-r-22 mg-l-22").siblings()[a ? "removeClass" :"addClass"]("hidden").end().end().children().first()[a ? "addClass" :"removeClass"]("mg-l-16"), 
                h.children('[data-ex="' + r.filteredType + '"]').length == 0 && (r.filteredType = h.children(":first").data("ex"), 
                h.children(":first").addClass("actived"), t()), $("#fg")[h[0].scrollLeft + h[0].clientWidth >= h[0].scrollWidth - 35 ? "addClass" :"removeClass"]("hidden"));
            }
        }), t = function() {
            b.trigger("AM_Update");
        }, et = function() {
            _cTimer != null && (Timer.remove(_cTimer), window._elapsed = 0);
        ...
        return {
            ...
            setMyMarketTypes:function(n, t, i, r) {
                var f = n + "|" + t + "|" + i, u = AMStore.getMyMarketTypes();
        ...
        var n = {
            ...
            switch (u.type) {
              case CONSTANTS.RIGHTPANEL.UPDATEBETSLIP:
                if (n = _.assign({
                    abo:n.abo,
                    sbc:n.sbc
                }, u.BS_Data), t.showLoading = !1, n != null && n.s != null && n.s.length > 0) {
                    for (u.isRefresh && t.editingId != "" || (t.editingId = n.s[0].sid), s = {}, c = [], 
                    o = 0; o < n.s.length; o++) f = n.s[o], f.st > 0 ? e(f) :f.st == 0 && (f.st = null), 
            ...
            if (t.currentMode != r.PLACEBET) {
                ...
                n.tc = $.grep(n.c, function(n) {
                    ...
                    return (n.cerr == null || n.cerr == "") && (i = !0), _.assign({}, n);
                });
            ...
            for (var h = c(i), y = p(i), o = isNaN(parseFloat(y)) ? null :parseFloat(y), w = ("" + y).length != ("" + o).length, f, s = 0; s < n.s.length; s++) if (f = n.s[s], 
            f.sid == t) {
                r ? (f.st = u ? f.st == null ? o :parseFloat(f.st) + o :o, e(f), w && (f.st = f.st == null ? h :("" + f.st).split(".")[0] + h)) :(f.towin = o, 
                d(f), f.towin != null && w && (f.towin += h));
                break;
            }
            n.c[0] && (n.c[0].cba = null, v());
            l();
            a();
        }, y = function(t, i, r) {
            for (var s = c(i), o = p(i), f = isNaN(parseFloat(o)) ? null :parseFloat(o), h = ("" + o).length != ("" + f).length, u, e = 0; e < n.c.length; e++) if (u = n.c[e], 
            u.wid == t) {
            ...
            var i = c(n), t = n, r;
            return i != null && (r = t.split(".")[0] == "" ? "0" :t.split(".")[0], t = r + i), 
            t;
        }, e = function(n) {
            var i = n.st == null ? 0 :n.st, r = n.bs.bmax, t = n.o, u = n.bo;
            i > 0 && t !== 0 ? i > r ? (n.st = r, n.towin = o(r, t, u)) :n.towin = o(i, t, u) :(t === 0 && (n.st = null), 
            n.st == 0 ? n.towin = 0 :n.st == null && (n.towin = null));
        }, d = function(n) {
            var r = n.towin == null ? 0 :n.towin, i = n.bs.bmax, t = n.o, u = n.bo;
            r > 0 && t !== 0 ? (n.st = g(r, t, u), n.st > i && (n.st = i, n.towin = o(i, t, u))) :(t === 0 && (n.st = null, 
            n.towin = null), n.towin == 0 ? n.st = 0 :n.towin == null && (n.st = null));
        }, w = function(t) {
            var u = t.cba == null ? 0 :t.cba, s = t.cbs.bmax, f = t.co, h = t.bc, o, i, r;
            if (t.wid == 1) if (u > 0 && f !== "0") {
                for (o = 0, i = 0; i < n.s.length; i++) r = n.s[i], r.st = u, e(r), o += r.towin;
                t.payout = o;
            } else {
                for (i = 0; i < n.s.length; i++) r = n.s[i], r.st = null, e(r);
                t.payout = null;
            } else u > 0 && f !== "0" ? (u > s && (t.cba = s), t.payout = t.cba * f - t.cba * h) :(f === "0" && (t.cba = null), 
            t.payout = null);
        }, o = function(t, i, r) {
            var f = 0, u = n.ot;
            return r == 1 && (u = 1), f = u == 1 ? t * (i - 1) :u == 2 ? t * i :i < 0 ? t :t * i, 
            ...
            if (n.s[0] != null) {
                var o = [], k = 0, d = [], h = [], nt = 0;
                for (t = 0, s = n.s.length; t < s; t++) if (i = n.s[t], i.ip != "true" && i.ap != !1 && i.rsl != 8888) {
                    for (u = 0; u < h.length; u++) h[u] == i.eid && (d[nt++] = i.eid);
                    h[h.length] = i.eid;
                }
                for (c = d.unique(), t = 0; t < n.s.length; t++) if (i = n.s[t], i.ip != "true" && i.ap != !1 && i.rsl != 8888) if (c.length > 0) for (l = 0; l < c.length; l++) c[l] != i.eid && (o[k++] = parseFloat(i.eo)); else o[k++] = parseFloat(i.eo);
                var e = o.length, tt = new Array(e), a = new Array(e);
                for (t = 0; t < e; t++) a[t] = o[t];
                var s = 2, g = 0, p = {};
                for (t = 1; t < e; t++) {
                    for (v = 0, f = e - 1; f >= t; f--) {
                        for (b = 0, y = f - 1; y >= t - 1; y--) b += a[y];
                        a[f] = o[f] * b;
                        v += a[f];
                    }
                    g += v;
                ...
                for (t > 2 && (p[BS.Utility.FullCoverWager(e)] = g), u = 0; u < n.c.length; u++) r = n.c[u], 
                r != null && (r.co = p[r.wid], r.cba = r.cba > 0 && n.iscom ? r.cba :null, r.cba == null ? r.payout = null :w(r));
            }
        }, l = function() {
            for (var h = 0, c = 0, l = 0, a = 0, u = 0, v = 0, o, f, r, i, e, y, s, t = 0; t < n.s.length; t++) o = n.s[t], 
            f = o.st, f != null && f > 0 && (h++, l += f, u += o.towin);
            for (t = 1; t < n.c.length; t++) r = n.c[t], i = r.cba, i != null && i > 0 && (e = r.bc, 
            y = r.co == null ? "" :r.co, c += e, a += i * e, v += i * y - i * e);
            n.s.length > 1 && (s = n.c[0], s.payout = null, u > 0 && (s.payout = u));
            n.totalBet = h + c;
            n.totalStake = l + a;
            n.totalPay = u + v;
        }, tt = function() {
            var u = 0, f = 0, e = 0, t, s, i, r;
            if (n.s[0] != null) for (i = 0; i < n.s.length; i++) t = n.s[i], t.st > 0 && (s = o(t.st, t.o, t.bo), 
            t.rsl == 9999 && (u++, f += t.st, e += s), t.towin = s, t.st = t.st);
            if (n.c[0] != null) for (i = 1; i < n.c.length; i++) r = n.c[i], r.cba > 0 && r.rsl == 9999 && (u += r.bc, 
            f += r.cba * r.bc, e += r.payout);
            n.totalBet = u;
            n.totalStake = f;
            n.totalPay = e;
        }, a = function() {
            for (var t = "", r, i = 0; i < n.s.length; i++) r = n.s[i], t += (r.st != null ? r.st :0) + BS.SEPARATOR;
            t = t.slice(0, -1);
            BS.WriteSStakeCookies(t);
        }, v = function() {
            for (var t = "", r, i = 0; i < n.c.length; i++) r = n.c[i], t += (r.cba != null ? r.cba :0) + BS.SEPARATOR;
            t = t.slice(0, -1);
...
Action.RightPanel = {
    ...
    betReceiptToPrint:function() {
        return BS.BetReceiptToPrint();
    },
...
var MB_Store = {
        ...
        var i = {
            ...
            if (t) {
                if (n.selobj.ip && t) {
                    ...
                    var i = t.d.c[0].e[0].i[7], f = t.d.c[0].e[0].i[0], e = t.d.c[0].e[0].i[1], u = t.d.c[0].e[0].ibs, o = t.d.c[0].e[0].ibsc;
                }
                uv.login ? utility.service("LiveTv", "GetLiveEventDetails", {
                    Date:"",
                    SportId:t.d.k,
                ...
                }) :(uv.cdbg && liveCentreControl.clearMbInfo(!0), u && o && liveCentreControl.saveMbInfo(r, f, e, t.d.k, global.lan, i, t.d.c[0].e[0].pvdr, !0));
                uv.cdbg && (s = setInterval(function() {
                    var r, n, t, i;
                    mpc.pv == 2 && (r = !1, n = liveCentreControl.getMbInfo(!0), n ? n.playingEventId && (i = uv.login ? n.playingLsId :"", 
                    ...
                    t ? (i = uv.login ? t.playingLsId :"", liveCentreControl.play(t.playingEventId, t.hTeamName, t.aTeamName, t.sportId, i, t.videoProvider, r)) :liveCentreControl.showErrorMsg()), 
                    clearInterval(s));
                }, 1e3));
    ...
    createNew:function() {
        ...
        }, e = MB_Store.DispatchToken, f = dispatcher.register(function(t) {
            switch (t.type) {
              case CONSTANTS.SITEREFRESH:
    ...
    filterCompetition:function() {
        for (var i = window.location.href.split("/"), r = window.location.pathname.toString(), h = !1, e, u, f, t, s, n = 0; n < i.length; n++) i[n].indexOf("#") > 0 && (h = !0);
        if (h) for (r = "", e = !1, n = 0; n < i.length; n++) e && (i[n].indexOf("?") > 0 && (i[n] = i[n].split("?")[0]), 
        r = r + "/" + i[n]), i[n].indexOf("#") > 0 && (e = !0);
        u = "";
        ...
        selobj.btp != selobj.btp2 ? (t = r.split("/"), t[t.length - 1] = selobj.btp2, r = t.join("/")) :(t = r.split("/"), 
        t[t.length - 1] = "default", r = t.join("/"));
        s = r;
        s += u;
        ocomp.isFirstLoad = !1;
    ...
    initComp:function() {
        ...
        if (o.param.Tab == "Inplay" || o.param.IsInplay) $("#cpHeaderTxt").text(l.ip.toUpperCase()), 
        $("span.cpact.favcp").hide(); else {
    ...
    cpact_click:function(n) {
        ...
        if (t.hasClass("span-toggle")) n.preventDefault(), n.stopPropagation(), s = t.parent().next(), 
        i = s.attr("cg"), t = t.add($('.tb[cg="' + i + '"]:hidden').prev().children("span:eq(0)")), 
        ...
        s.show("blind", function() {
            t.removeClass("lock");
            $("table[cg=" + i + "]").show();
        })), ScrollerBar.initScrollbarStatus(); else if (t.children(".span-toggle").length) n.preventDefault(), 
        n.stopPropagation(), t.children(".span-toggle").click(); else if (t.hasClass("favcp")) y = parseInt(t.attr("c"), 10), 
        t.hasClass("actived") ? (t.removeClass("actived"), t.attr("title", l.LP_RemoveMyComp)) :(t.addClass("actived"), 
        t.attr("title", l.LP_Add2MyComp)), Action.LeftPanel.MyCompetition.toggle({
            sid:o.param.SportId,
            sn:ocomp.sportName,
            cid:y,
            cn:t.closest("td").next().find("span").text().trim()
        }); else if (t.hasClass("group-txt") || t.hasClass("comp-txt")) p = t.attr("id").replace("_spn", ""), 
        $("#" + p).trigger("click"); else if (t.hasClass("allSPN")) t.prev().trigger("click"); else if (t.hasClass("cp")) {
            var i = t.attr("cg"), w = t.attr("value"), b = !0;
            ...
            var i = t.attr("cg"), r = "selected", f = "selected";
            t.hasClass(r) ? ($("span.cpact.cgCB[cg=" + i + "]").removeClass(r), $("span.cpact.cp[cg=" + i + "]").removeClass(f)) :($("span.cpact.cgCB[cg=" + i + "]").addClass(r), 
            ...
            ocomp.sethighlighted();
            n.stopPropagation();
        } else if (t.hasClass("allCB")) r = "selected", f = "selected", t.hasClass(r) ? (t.removeClass(r), 
        $("span.cgCB").removeClass(r), $("span.cp.select").removeClass(f)) :(t.addClass(r), 
        $("span.cgCB").addClass(r), $("span.cp.select").addClass(f)), ocomp.showSumitButton(), 
        ocomp.sethighlighted(); else if (t.hasClass("sbmt")) {
            var g = $("span.cp.select").map(function() {
                if ($(this).hasClass("selected")) return this;
            }), nt = $("span.allCB").hasClass("selected"), k = [];
            g.each(function() {
                k.push($(this).attr("value"));
            });
            c = k.unique().join(",");
            c == "" ? (d = l.SelectCompetition, v = l.AtLeast1Competition, Control.Dialog ? pm.showParentAlert(d, v) :alert(v)) :(e = ocomp.prepareUrl() + "?competitionids=" + c, 
            ocomp.currentSliderLeftBetType = 0, ocomp.currentSliderLeftDateType = 0, utility.cookie.write(o.Select_All_Comps, nt ? -1 :c.split(",").length), 
            Action.Competition.filterCompetition(e));
        } else t.hasClass("by-time") ? t.hasClass("selected") || (o.param.UIBetType = "ftahou", 
        selobj.btp = "full-time-asian-handicap-and-over-under", t.attr("id") == "cpTab_all" ? (ocomp.isAllComp = !0, 
        ocomp.isFirstLoad = !1, ocomp.filterCompetition()) :t.attr("id") == "cpTab_today" ? (ocomp.isAllComp = !1, 
        o.param.IsFutureDate = !1, o.param.Tab = "Today", ocomp.filterCompetition()) :t.attr("id") == "cpTab_date" && (ocomp.isAllComp = !1, 
        t.hasClass("future") && (o.param.IsFutureDate = !0), o.param.Tab = "Date", o.param.EventDate = ocomp.defaultDate, 
        ocomp.filterCompetition())) :t.hasClass("defbtn") ? (a = t.find("span:eq(1)"), a.hasClass("selected") ? (Action.Competition.ChangeDefaultButton(!1), 
        a.removeClass("selected")) :(Action.Competition.ChangeDefaultButton(!0), a.addClass("selected"))) :t.hasClass("tps") ? (s = t.find("span.fts-13"), 
        h = s.attr("tg"), s.hasClass("bt-cpCount") && (o.param.UIBetType = "ftahou", selobj.btp = selobj.btp2 = "full-time-asian-handicap-and-over-under", 
        h == "today" ? (ocomp.isAllComp = !1, o.param.Tab = "Today", e = ocomp.prepareUrl()) :h == "tomorrow" ? (ocomp.isAllComp = !1, 
        o.param.Tab = "Date", o.param.Tab = "Today", e = ocomp.prepareUrl().replace("today", "tomorrow")) :h == "am" ? (ocomp.isAllComp = !0, 
        e = ocomp.prepareUrl()) :(ocomp.isAllComp = !0, e = ocomp.prepareUrl() + "?competitionids=" + h), 
        Action.Competition.filterCompetition(e))) :t.hasClass("filters") ? t.hasClass("filterdate") ? (ocomp.currentSliderLeftBetType = 0, 
        ocomp.isAllComp = !1, o.param.Tab = "Date", o.param.IsFutureDate = !1, o.param.EventDate = t.attr("d"), 
        t.attr("tag") == "future" && (o.param.IsFutureDate = !0), ocomp.filterCompetition()) :t.hasClass("actived") || (t.parent().find("div").removeClass("actived"), 
        $("#divdate").hide(), t.addClass("actived"), selobj.btp2 == "outright" && (selobj.btp2 = "full-time-asian-handicap-and-over-under"), 
        selobj.btp2 = selobj.btp, ocomp.currentSliderLeftBetType = 0, t.attr("id") == "midf" ? (ocomp.isAllComp = !0, 
        ocomp.isFirstLoad = !1, ocomp.filterCompetition()) :t.attr("id") == "midd" ? ($("#divdate").show(), 
        ocomp.currentSliderLeftDateType = 0, ocomp.setDefaultSlider(), ocomp.CheckArrow($("#DateFilter"))) :t.attr("id") == "midt" ? (ocomp.isAllComp = !1, 
        o.param.IsFutureDate = !1, o.param.Tab = "Today", ocomp.filterCompetition()) :t.attr("id") == "mido" && (selobj.btp2 = "outright", 
        ocomp.isAllComp = !1, $("#divbt").hide(), ocomp.filterCompetition())) :t.hasClass("bf") ? (ocomp.isAllComp = $("#midf").hasClass("actived"), 
        selobj.btp2 = t.attr("expr"), ocomp.filterCompetition()) :t.hasClass("cmp") && t.closest("tr").find("span.cp.select").click();
    },
    initFavComp:function() {
        var n, t, i;
        if ($("span.cpact.favcp").removeClass("actived").attr("title", l.LP_Add2MyComp), 
        n = LPM.mycomps, n != null && n != "") for (t = 0; t < n.length; t++) i = n[t], 
        $("span.cpact.favcp[c=" + i + "]").addClass("actived").attr("title", l.LP_RemoveMyComp);
    },
    checkCompetition:function(n) {
        for (var f = n == null ? null :n.split(","), t = "selected", r = "selected", u, i = 0; i < f.length; i++) $("span.cp.select").each(function() {
            $(this).attr("value") == f[i] && $(this).addClass(r);
        });
        $("span.cgCB").each(function() {
            var i = $(this).attr("cg"), n = !0;
    ...
    setCompTab:function() {
        ...
        $("#divdate").show(), n = $("#DateFilter div.filterdate"), i = ocomp.convertDateFormat(o.param.EventDate, 2), 
        n.removeClass("actived"), n.each(function() {
            if ($(this).attr("d") == i) {
    ...
    convertDateFormat:function(n, t) {
        ...
        f = !0)), !f) {
            ...
            } else u = n.split("-"), u.length === 3 && (e = parseInt(u[0], 10), i = parseInt(u[1], 10) - 1, 
            o = parseInt(u[2], 10));
            r = new Date(e, i, o);
            Object.prototype.toString.call(r) === "[object Date]" && (isNaN(r.getTime()) || (f = !0));
        }
        if (f) {
            var h = r.getFullYear(), l = r.getMonth() + 1, c = [ "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec" ][r.getMonth()], a = [ "Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat" ][r.getDay()], s = r.getDate();
    ...
    prepareUrl:function() {
        ...
        return o.param.IsInplay || o.param.Tab == "Inplay" ? (t = "in-play", n = 0, $("input.cpact.cp:checked").each(function() {
            var t = parseInt($(this).attr("cg"), 10);
            return n == 0 && n != t && (n = t), n != t ? (n = -1, !1) :void 0;
        }), i = n > 0 ? n.toString() :"all") :ocomp.isAllComp ? t = "competition" :(t = "matches-by-date", 
        d = "", o.param.IsFutureDate ? d = "future" :(d = o.param.Tab == "Today" ? "today" :o.param.Tab == "Date" ? ocomp.convertDateFormat(o.param.EventDate, 2) :ocomp.convertDateFormat(new Date(), 2), 
        $("#cpTab_today").hasClass("selected") && (d = "today")), t = t + "/" + d, o.param.Tab == "Popular" && (t = "popular")), 
        "/" + f + "/sports/" + i + "/" + t + "/" + e;
    },
    expandOther:function(n) {
        ...
        }); t < n; ) t++, i = $("#comp-div").find(".lowRes span.span-toggle.collapsed").eq(0), 
        r = $("#comp-div").find(".highRes span.span-toggle.collapsed").eq(0), i.removeClass("collapsed").addClass("expand"), 
        r.removeClass("collapsed").addClass("expand"), i.parent().next().show(), r.parent().next().show();
        ocomp.expandIfChecked();
    },
    expandIfChecked:function() {
        var n = "selected";
        $("span.cgCB").each(function() {
            var t = $(this).parent().next(), r = $(t).parent().next(), u = $(this).attr("cg"), i = !1;
            $("span.cp[cg=" + u + "]").each(function() {
                $(this).hasClass(n) && (i = !0);
            });
            i && ($(t).removeClass("collapse").addClass("expand"), $(r).show());
        });
    },
    ...
    setDateRang:function() {
        ...
        if (i) {
            for (n = 1; n < i.length; ++n) t = i[n], n == 1 && r.appendFormat('<div class="width-35 right-0 height-40 pos-absolute gradientFadeOut-r"></div>'), 
    ...
    setTopSectionData:function(n, t) {
        ...
        return i && (i = _.sortBy(i, "s"), f = {
            cids:"",
            ec:0,
            gi:0,
            s:-1
        }, u = ocomp.rearrangementDataforRow(i, t, f, 1)), r.om = u, r;
    },
    ...
    rearrangementDataforRow:function(n, t, i, r) {
        ...
        return t === 2 ? $.each(n, function(t) {
            u[f] = this;
            f++;
            t % 2 == 1 ? (e.push(u), u = [], f = 0) :t == n.length - 1 && (u[f] = i, e.push(u));
        }) :r == 1 ? $.each(n, function(t) {
            t == 0 ? (u[0] = u[1] = i, u[2] = this, e.push(u), u = []) :(u[f] = this, f++, t % 3 == 0 ? (e.push(u), 
            u = [], f = 0) :t == n.length - 1 && (u.length == 1 ? u[1] = u[2] = i :u[2] = i, 
            e.push(u), u = []));
        }) :$.each(n, function(t) {
            u[f] = this;
            f++;
            (t + 1) % 3 == 0 ? (e.push(u), u = [], f = 0) :t == n.length - 1 && (u.length == 1 ? u[1] = u[2] = i :u[2] = i, 
            e.push(u), u = []);
        }), e;
    },
    ...
    sethighlighted:function() {
        ...
        n.each(function() {
            ...
            $(this).hasClass("selected") ? (n.removeClass("ft-c-47"), n.addClass("ft-c-16")) :(n.addClass("ft-c-47"), 
            n.removeClass("ft-c-16"));
        });
    },
    CheckArrow:function(n) {
        var t = n, f = t.outerWidth(), r = parseInt(t.find("span:eq(0),div.filterdate:eq(0)").css("left"), 10) || 0, i = 0, u = !1;
        ...
        i = i + 12;
        i < f ? (t.parent().children(".float-left").find("span").addClass("hidden"), t.parent().children(".float-right").find("span").addClass("hidden"), 
        ocomp.currentSliderLeftBetType = 0, ocomp.currentSliderLeftDateType = 0, ocomp.setDefaultSlider(), 
    ...
    SliderEvent:function() {
        ...
        ocomp.is_rnr || (i.hasClass("lb") ? (ocomp.is_rnr = !0, t = parseInt(n.children("span:First").css("left"), 10) || 0, 
        t = t == "auto" ? 0 :t, t != 0 ? (sliderwidth = t + r, n.children("span:First").animate({
        ...
        })) :ocomp.is_rnr = !1) :i.hasClass("rb") ? (ocomp.is_rnr = !0, t = parseInt(n.children("span:First").css("left"), 10) || 0, 
        t = t == "auto" ? 0 :t, t == 0 ? n.children("span:First").animate({
            left:t - r
        }, {
            duration:ocomp.Sliderduration,
            step:function(t) {
        ...
        }) :ocomp.is_rnr = !1) :i.hasClass("ld") ? (ocomp.is_rnr = !0, t = parseInt(n.children("div.filterdate:First").css("left"), 10) || 0, 
        t = t == "auto" ? 0 :t, t != 0 ? n.children("div.filterdate:First").animate({
            left:r >= 0 ? 0 :r
        }, {
            duration:ocomp.Sliderduration,
            step:function(t) {
        ...
        }) :ocomp.is_rnr = !1) :i.hasClass("rd") && (ocomp.is_rnr = !0, t = parseInt(n.children("div.filterdate:First").css("left"), 10) || 0, 
        t = t == "auto" ? 0 :t, f ? n.children("div.filterdate:First").animate({
            left:-r
        }, {
            duration:ocomp.Sliderduration,
            step:function(t) {
